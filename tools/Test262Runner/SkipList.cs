...
internal static class SkipList
{
    ...
    [
        new(
            "__proto__",
            SkipSpecStatus.Legacy,
            SkipDisposition.UnsupportedByPolicy,
            SkipPriority.None,
            "Legacy __proto__ web-compat surface is intentionally unsupported in Okojo."
        ),
        new(
            "Error.isError",
            SkipSpecStatus.FinishedProposalNotInBaseline,
            SkipDisposition.DeferredImplementation,
            SkipPriority.Medium,
    ...
    [
        ...
        new(
            "language/expressions/arrow-function/scope-param-",
            "Intentional skip: direct eval is treated as normal eval (no direct-eval parameter environment semantics)"
        ),
        new(
            "language/expressions/function/scope-param-",
            "Intentional skip: direct eval is treated as normal eval (no direct-eval parameter environment semantics)"
        ),
        new(
            "language/statements/function/scope-param-",
            "Intentional skip: direct eval is treated as normal eval (no direct-eval parameter environment semantics)"
        ),
        new(
            "language/expressions/object/scope-meth-param-",
            "Intentional skip: direct eval is treated as normal eval (no direct-eval parameter environment semantics)"
        ),
        new(
        ...
        new(
            "language/eval-code/direct/this-value-",
        ...
        new(
            "language/eval-code/indirect/this-value-",
            "Intentional skip: eval always uses global-eval path in Okojo"
        ),
        new(
        ...
        new(
            "language/expressions/call/eval-spread",
        ...
        new(
            "language/expressions/object/__proto__",
        ...
        new(
            "built-ins/Array/prototype/concat/create-proto-from-ctor-realm",
            "Intentional skip: Array[Symbol.species] is intentionally unsupported; array methods always create base Array results"
        ),
        new(
            "built-ins/Array/prototype/concat/create-species-with-",
            "Intentional skip: Array[Symbol.species] is intentionally unsupported; array methods always create base Array results"
        ),
        new(
            "built-ins/Array/prototype/concat/create-species-non-extensible",
            "Intentional skip: Array[Symbol.species] is intentionally unsupported; array methods always create base Array results"
        ),
        new(
        ...
        new(
            "built-ins/Array/prototype/filter/create-proto-from-ctor-realm",
            "Intentional skip: Array[Symbol.species] is intentionally unsupported; array methods always create base Array results"
        ),
        new(
        ...
        new(
            "built-ins/Array/prototype/map/create-proto-from-ctor-realm",
            "Intentional skip: Array[Symbol.species] is intentionally unsupported; array methods always create base Array results"
        ),
        new(
        ...
        new(
            "built-ins/Array/prototype/slice/create-proto-from-ctor-realm",
            "Intentional skip: Array[Symbol.species] is intentionally unsupported; array methods always create base Array results"
        ),
        new(
        ...
        new(
            "built-ins/Array/prototype/splice/create-proto-from-ctor-realm",
            "Intentional skip: Array[Symbol.species] is intentionally unsupported; array methods always create base Array results"
        ),
        new(
        ...
        new(
            "built-ins/Array/prototype/flat/target-array-",
            "Intentional skip: Array[Symbol.species] is intentionally unsupported; array methods always create base Array results"
        ),
        new(
            "built-ins/Array/prototype/flatMap/target-array-",
            "Intentional skip: Array[Symbol.species] is intentionally unsupported; array methods always create base Array results"
        ),
        new(
            "built-ins/Array/prototype/flatMap/this-value-ctor-object-species",
            "Intentional skip: Array[Symbol.species] is intentionally unsupported; array methods always create base Array results"
        ),
        new(
        ...
        new(
            ...
            "Intentional skip: with statement not supported"
        ),
        new(
        ...
        new(
            "language/expressions/dynamic-import/syntax/valid/nested-with-",
            "Intentional skip: with statement semantics are intentionally unsupported in Okojo"
        ),
        new(
            "language/expressions/dynamic-import/syntax/valid/import-source-",
            "Intentional skip: source-phase-imports/import.source proposal semantics are not implemented in Okojo"
        ),
        new(
            "language/expressions/dynamic-import/syntax/valid/import-defer-",
            "Intentional skip: import.defer proposal semantics are not implemented in Okojo"
        ),
        new(
            "language/expressions/dynamic-import/syntax/valid/top-level-import-source-",
            "Intentional skip: source-phase-imports/import.source proposal semantics are not implemented in Okojo"
        ),
        new(
            "language/expressions/dynamic-import/syntax/valid/top-level-import-defer-",
            "Intentional skip: import.defer proposal semantics are not implemented in Okojo"
        ),
        new(
            "language/expressions/dynamic-import/syntax/valid/nested-if-import-source-",
            "Intentional skip: source-phase-imports/import.source proposal semantics are not implemented in Okojo"
        ),
        new(
            "language/expressions/dynamic-import/syntax/valid/nested-if-import-defer-",
            "Intentional skip: import.defer proposal semantics are not implemented in Okojo"
        ),
        new(
            "language/expressions/dynamic-import/syntax/valid/nested-if-braceless-import-source-",
            "Intentional skip: source-phase-imports/import.source proposal semantics are not implemented in Okojo"
        ),
        new(
            "language/expressions/dynamic-import/syntax/valid/nested-if-braceless-import-defer-",
            "Intentional skip: import.defer proposal semantics are not implemented in Okojo"
        ),
        new(
            "language/statements/class/decorator/",
            "Intentional skip: decorators proposal syntax is not implemented in Okojo"
        ),
        new(
            "language/statements/class/elements/privatename-not-valid-eval-earlyerr-",
            "Intentional skip: direct eval is treated as normal eval (no direct-eval private-environment early-error semantics)"
        ),
        new(
            "language/statements/class/elements/direct-eval-",
            "Intentional skip: direct eval is treated as normal eval (no direct-eval class-element private/super/new.target semantics)"
        ),
        new(
            "language/statements/class/elements/private-direct-eval-",
            "Intentional skip: direct eval is treated as normal eval (no direct-eval class-element private/super/new.target semantics)"
        ),
        new(
            "language/statements/class/elements/nested-direct-eval-",
            "Intentional skip: direct eval is treated as normal eval (no direct-eval class-element private/super/new.target semantics)"
        ),
        new(
            "language/statements/class/elements/nested-private-direct-eval-",
            "Intentional skip: direct eval is treated as normal eval (no direct-eval class-element private/super/new.target semantics)"
        ),
        new(
            "language/statements/class/elements/arrow-body-direct-eval-",
            "Intentional skip: direct eval is treated as normal eval (no direct-eval class-element private/super/new.target semantics)"
        ),
        new(
            "language/statements/class/elements/arrow-body-private-direct-eval-",
            "Intentional skip: direct eval is treated as normal eval (no direct-eval class-element private/super/new.target semantics)"
        ),
        new(
            "language/statements/class/elements/derived-cls-direct-eval-",
            "Intentional skip: direct eval is treated as normal eval (no direct-eval class-element private/super/new.target semantics)"
        ),
        new(
            "language/statements/class/elements/private-derived-cls-direct-eval-",
            "Intentional skip: direct eval is treated as normal eval (no direct-eval class-element private/super/new.target semantics)"
        ),
        new(
            "language/statements/class/elements/nested-derived-cls-direct-eval-",
            "Intentional skip: direct eval is treated as normal eval (no direct-eval class-element private/super/new.target semantics)"
        ),
        new(
            "language/statements/class/elements/nested-private-derived-cls-direct-eval-",
            "Intentional skip: direct eval is treated as normal eval (no direct-eval class-element private/super/new.target semantics)"
        ),
        new(
            "language/statements/class/elements/arrow-body-derived-cls-direct-eval-",
            "Intentional skip: direct eval is treated as normal eval (no direct-eval class-element private/super/new.target semantics)"
        ),
        new(
            "language/statements/class/elements/arrow-body-private-derived-cls-direct-eval-",
            "Intentional skip: direct eval is treated as normal eval (no direct-eval class-element private/super/new.target semantics)"
        ),
        new(
            "language/statements/class/elements/private-field-visible-to-direct-eval",
        ...
        new(
            "language/statements/class/elements/private-getter-visible-to-direct-eval",
            "Intentional skip: direct eval is treated as normal eval (no direct-eval private-name visibility semantics inside class elements)"
        ),
        new(
            "language/statements/class/elements/private-setter-visible-to-direct-eval",
            "Intentional skip: direct eval is treated as normal eval (no direct-eval private-name visibility semantics inside class elements)"
        ),
        new(
            "language/statements/class/elements/private-method-visible-to-direct-eval",
            "Intentional skip: direct eval is treated as normal eval (no direct-eval private-name visibility semantics inside class elements)"
        ),
        new(
        ...
        new(
            "test/language/statements/class/elements/static-field-init-with-this.js",
            "Intentional skip: direct eval is treated as normal eval (no direct-eval private-name visibility semantics inside class elements)"
        ),
        new(
            "language/expressions/dynamic-import/syntax/valid/nested-if-braceless-import-attributes-",
            "Intentional skip: dynamic import attributes syntax is not implemented in Okojo"
        ),
        new(
            "language/expressions/dynamic-import/syntax/valid/nested-function-import-source-",
            "Intentional skip: source-phase-imports/import.source proposal semantics are not implemented in Okojo"
        ),
        new(
            "language/expressions/dynamic-import/syntax/valid/nested-function-import-defer-",
            "Intentional skip: import.defer proposal semantics are not implemented in Okojo"
        ),
        new(
            "language/expressions/dynamic-import/syntax/valid/nested-function-import-attributes-",
            "Intentional skip: dynamic import attributes syntax is not implemented in Okojo"
        ),
        new(
            "language/expressions/dynamic-import/syntax/valid/nested-function-return-import-source-",
            "Intentional skip: source-phase-imports/import.source proposal semantics are not implemented in Okojo"
        ),
        new(
            "language/expressions/dynamic-import/syntax/valid/nested-function-return-import-defer-",
            "Intentional skip: import.defer proposal semantics are not implemented in Okojo"
        ),
        new(
            "language/expressions/dynamic-import/syntax/valid/nested-function-return-import-attributes-",
            "Intentional skip: dynamic import attributes syntax is not implemented in Okojo"
        ),
        new(
            "language/expressions/dynamic-import/syntax/valid/nested-else-braceless-import-source-",
            "Intentional skip: source-phase-imports/import.source proposal semantics are not implemented in Okojo"
        ),
        new(
            "language/expressions/dynamic-import/syntax/valid/nested-else-braceless-import-defer-",
            "Intentional skip: import.defer proposal semantics are not implemented in Okojo"
        ),
        new(
            "language/expressions/dynamic-import/syntax/valid/nested-else-braceless-import-attributes-",
            "Intentional skip: dynamic import attributes syntax is not implemented in Okojo"
        ),
        new(
            "language/expressions/dynamic-import/syntax/valid/nested-block-import-source-",
            "Intentional skip: source-phase-imports/import.source proposal semantics are not implemented in Okojo"
        ),
        new(
            "language/expressions/dynamic-import/syntax/valid/nested-block-import-defer-",
            "Intentional skip: import.defer proposal semantics are not implemented in Okojo"
        ),
        new(
            "language/expressions/dynamic-import/syntax/valid/nested-block-import-attributes-",
            "Intentional skip: dynamic import attributes syntax is not implemented in Okojo"
        ),
        new(
            "language/expressions/dynamic-import/syntax/valid/nested-block-labeled-import-source-",
            "Intentional skip: source-phase-imports/import.source proposal semantics are not implemented in Okojo"
        ),
        new(
            "language/expressions/dynamic-import/syntax/valid/nested-block-labeled-import-defer-",
            "Intentional skip: import.defer proposal semantics are not implemented in Okojo"
        ),
        new(
            "language/expressions/dynamic-import/syntax/valid/nested-block-labeled-import-attributes-",
            "Intentional skip: dynamic import attributes syntax is not implemented in Okojo"
        ),
        new(
            "language/expressions/dynamic-import/syntax/valid/nested-async-function-import-source-",
            "Intentional skip: source-phase-imports/import.source proposal semantics are not implemented in Okojo"
        ),
        new(
            "language/expressions/dynamic-import/syntax/valid/nested-async-function-import-defer-",
            "Intentional skip: import.defer proposal semantics are not implemented in Okojo"
        ),
        new(
            "language/expressions/dynamic-import/syntax/valid/nested-async-function-import-attributes-",
            "Intentional skip: dynamic import attributes syntax is not implemented in Okojo"
        ),
        new(
            "language/expressions/dynamic-import/syntax/valid/nested-async-function-return-await-import-source-",
            "Intentional skip: source-phase-imports/import.source proposal semantics are not implemented in Okojo"
        ),
        new(
            "language/expressions/dynamic-import/syntax/valid/nested-async-function-return-await-import-defer-",
            "Intentional skip: import.defer proposal semantics are not implemented in Okojo"
        ),
        new(
            "language/expressions/dynamic-import/syntax/valid/nested-async-function-return-await-import-attributes-",
            "Intentional skip: dynamic import attributes syntax is not implemented in Okojo"
        ),
        new(
        ...
        new(
            "language/expressions/dynamic-import/syntax/valid/top-level-import-source-empty-str-is-valid-assign-expr.js",
            "Intentional skip: source-phase-imports/import.source proposal semantics are not implemented in Okojo"
        ),
        new(
            "language/expressions/class/elements/direct-eval-",
            "Intentional skip: direct eval is treated as normal eval in Okojo"
        ),
        new(
            "language/expressions/class/elements/nested-direct-eval-",
            "Intentional skip: direct eval is treated as normal eval in Okojo"
        ),
        new(
            "language/expressions/class/elements/arrow-body-direct-eval-",
            "Intentional skip: direct eval is treated as normal eval in Okojo"
        ),
        new(
            "language/expressions/class/elements/arrow-body-derived-cls-direct-eval-",
            "Intentional skip: direct eval is treated as normal eval in Okojo"
        ),
        new(
            "language/expressions/class/elements/private-direct-eval-",
            "Intentional skip: direct eval is treated as normal eval in Okojo"
        ),
        new(
            "language/expressions/class/elements/arrow-body-private-direct-eval-",
            "Intentional skip: direct eval is treated as normal eval in Okojo"
        ),
        new(
            "language/expressions/class/elements/derived-cls-direct-eval-",
            "Intentional skip: direct eval is treated as normal eval in Okojo"
        ),
        new(
            "language/expressions/class/elements/private-derived-cls-direct-eval-",
            "Intentional skip: direct eval is treated as normal eval in Okojo"
        ),
        new(
            "language/expressions/class/elements/arrow-body-private-derived-cls-direct-eval-",
            "Intentional skip: direct eval is treated as normal eval in Okojo"
        ),
        new(
            "language/expressions/class/elements/nested-derived-cls-direct-eval-",
            "Intentional skip: direct eval is treated as normal eval in Okojo"
        ),
        new(
            "language/expressions/class/elements/nested-private-direct-eval-",
            "Intentional skip: direct eval is treated as normal eval in Okojo"
        ),
        new(
        ...
        new(
            "intl402/Temporal/PlainMonthDay/prototype/toLocaleString/basic.js",
            "Intentional skip: relies on Temporal not in baseline yet"
        ),
        new(
            "language/arguments-object/S10.6_A3_T1.js",
            "Intentional skip: relies on deprecated arguments.callee"
        ),
        new(
        ...
        new(
            ...
            "Intentional skip: relies on legacy arguments.callee"
        ),
        new(
    ...
    internal static bool TryParseClassification(
        string reason,
        out SkipClassification classification
    )
    {
        ...
        if (
            !Enum.TryParse<SkipSpecStatus>(parts[0], ignoreCase: true, out var status)
    ...
    internal static string StripClassificationPrefix(string reason)
    {
        ...
        var end = reason.IndexOf(']');
        return end >= 0 && end + 2 <= reason.Length ? reason.Substring(end + 2) : string.Empty;
    }
    ...
    private static string FormatFeatureReason(
        string featureName,
        string note,
    ...
    private static SkipClassification ClassifyPathEntry(string? pattern, string reason)
    {
        ...
        if (reason.Contains("CRLF line endings", StringComparison.OrdinalIgnoreCase))
            return new(
                SkipSpecStatus.Other,
                SkipDisposition.EnvironmentOrHarness,
                SkipPriority.Low
            );

        if (
            reason.Contains(
                "dynamic import attributes syntax is not implemented",
        ...
        if (
            reason.Contains("source-phase-imports", StringComparison.OrdinalIgnoreCase)
            ...
            || reason.Contains(
                "experimental joint-iteration surface",
                StringComparison.OrdinalIgnoreCase
            )
        )
            return new(
        ...
        if (
            reason.Contains("Array[Symbol.species]", StringComparison.OrdinalIgnoreCase)
        ...
        if (
            reason.Contains("direct eval", StringComparison.OrdinalIgnoreCase)
        ...
        if (
            reason.Contains(
                "SharedArrayBuffer builtin is not implemented",
                StringComparison.OrdinalIgnoreCase
            )
        )
        ...
        if (
            reason.Contains("temporarily deferred", StringComparison.OrdinalIgnoreCase)
            || reason.Contains(
                "traded off for compile-time performance",
                StringComparison.OrdinalIgnoreCase
            )
        )
            return new(
                SkipSpecStatus.Standard,
                SkipDisposition.IntentionalDeviation,
                SkipPriority.Medium
            );

        if (
            reason.Contains(
                "not a useful Okojo conformance target",
                StringComparison.OrdinalIgnoreCase
            )
        )
            return new(
        ...
        if (
            reason.Contains("not fully modeled", StringComparison.OrdinalIgnoreCase)
