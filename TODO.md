...
- [ ] expand direct flat parsing beyond completed calls/member loads, data literals, and array binding declarations through remaining destructuring, classes, and modules before replacing the production class parser
