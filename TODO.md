...
- [ ] expand direct flat parsing beyond completed calls/member loads, data literals, bindings, destructuring assignments, pattern parameters, and ordinary function expressions through classes and modules before replacing the production class parser
