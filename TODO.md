...
- [ ] direct-flat modules: establish flat hoisted-function instantiation ownership, then add dynamic import/`import.meta`, top-level-await execution, and default-path adoption
