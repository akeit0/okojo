...
- [ ] expand direct flat parsing beyond completed calls/member loads, data literals, and binding declarations through destructuring assignments, pattern parameters, classes, and modules before replacing the production class parser
