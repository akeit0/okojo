...
- [ ] expand direct flat parsing beyond completed calls/member loads through literals, destructuring, classes, and modules before replacing the production class parser
