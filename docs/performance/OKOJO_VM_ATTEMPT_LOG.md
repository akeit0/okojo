...
- [E016: per-invocation RegExp callback argument reuse](OKOJO_REGEXP_ARGUMENT_REUSE.md): retained for global intrinsic matching and normal bytecode callbacks. Saves 5,544/6,552 B per eligible 64-match call; long-warmup gains 1.20%/2.70%, with a 100 ns non-global control cost. Five regressions added; full suite 2,262 passed, 4 skipped.
