...
public class StringPrototypeTests
{
    ...
    [Test]
    public void String_Match_Uses_BuiltIn_SymbolMatch_On_Internally_Created_RegExp_And_MatchAll_Undefined_Uses_Empty_RegExp()
    {
        var realm = JsRuntime.Create().DefaultRealm;
        realm.Eval(
            """
        ...
        Assert.That(
            realm.Accumulator.AsString(),
            Is.EqualTo("true|true|string source||0|target|2||0|1")
        );
    }
    ...
    public void String_Replace_Uses_RegExp_Replace_Path()
    {
        ...
        Assert.That(
            realm.Accumulator.AsString(),
            Is.EqualTo("She sells seaschells by the seashore.")
        );
    }
    ...
    public void String_Match_Exposes_Duplicate_Named_Groups_In_Source_Order()
    {
        ...
        Assert.That(
            realm.Accumulator.AsString(),
            Is.EqualTo("true|b|a|c|x,y,z|true|a|undefined|d|x,y,z")
        );
    }
    ...
    public void RegExp_Flags_Property_Can_Be_Redefined_On_Instance()
    {
        ...
        Assert.That(
            realm.Accumulator.AsString(),
            Is.EqualTo("undefined|undefined|false|false|undefined")
        );
    }
