...
public class ModuleExecutionGapTests
{
    ...
    public void RealmImport_DelegatesToAgentModules()
    {
        var loader = new InMemoryModuleLoader(
            new(StringComparer.Ordinal) { ["/mods/main.js"] = "export const value = 7;" }
        );
    ...
    {
        var loader = new InMemoryModuleLoader(
            new(StringComparer.Ordinal) { ["/mods/main.js"] = "export const value = 1;" }
        );
    ...
    {
        var loader = new InMemoryModuleLoader(
            new(StringComparer.Ordinal) { ["/mods/main.js"] = "export { ;" }
        );
    ...
    public void EvaluateModule_ExportStar_AmbiguousName_FailsNamedImport()
    {
        ...
        Assert.That(
            ((JsRuntimeException)ex.InnerException!).DetailCode,
            Is.EqualTo("MODULE_IMPORT_NAME_NOT_FOUND")
        );
    }
    ...
    public void EvaluateModule_ExportFromMissingName_ThrowsDiagnostic()
    {
        ...
        Assert.That(
            ((JsRuntimeException)ex.InnerException!).DetailCode,
            Is.EqualTo("MODULE_EXPORT_NAME_NOT_FOUND")
        );
        Assert.That(ex.Message, Does.Contain("missing"));
        Assert.That(ex.Message, Does.Contain("/mods/main.js"));
        Assert.That(ex.Message, Does.Contain("/mods/dep.js"));
    ...
    {
        var loader = new InMemoryModuleLoader(
            new(StringComparer.Ordinal) { ["/mods/main.js"] = """boom(); export const x = 1;""" }
        );
