...
public class ArrayPrototypeMethodsTests
{
    ...
    public void ArrayPrototype_ToLocaleString_Passes_Locales_And_Options_To_Elements()
    {
        ...
        Assert.That(
            result.AsString(),
            Is.EqualTo("2|true|true|false|false,2|false|false|true|true")
        );
    }
    ...
    [Test]
    public void ArrayPrototype_ToLocaleString_Invokes_Element_Method_With_No_Arguments_And_Supports_ForOf_Object_Destructuring_Repro()
    {
        var realm = JsRuntime.Create().DefaultRealm;
        var script = JsCompiler.Compile(
            realm,
    ...
    public void ArrayPrototype_Sort_Accessor_Delete_Capture_Repro_Works()
    {
        ...
        Assert.That(
            realm.Accumulator.AsString(),
            Is.EqualTo("a|b|c|d|undefined|undefined|undefined|false|false|8|c")
        );
    }
