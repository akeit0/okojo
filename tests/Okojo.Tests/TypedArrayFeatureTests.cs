...
public class TypedArrayFeatureTests
{
    ...
    {
        var realm = JsRuntime.Create().DefaultRealm;
        realm.Global["detachBuffer"] = new JsHostFunction(
            realm,
            (in info) =>
            {
                ...
                if (
                    ...
                    throw new JsRuntimeException(
                        ...
                        "detachBuffer requires an ArrayBuffer"
                    );
                buffer.Detach();
    ...
    public void TypedArray_FindLast_Uses_Internal_Length_And_Live_Element_Reads()
    {
        ...
        Assert.That(
            ...
            Is.EqualTo("3||0||undefined||4:2|undefined:1|undefined:0")
        );
    }
    ...
    public void TypedArray_FindLastIndex_Uses_Internal_Length_And_Live_Element_Reads()
    {
        ...
        Assert.That(
            realm.Accumulator.AsString,
            Is.EqualTo("2||0||-1||4:2|undefined:1|undefined:0")
        );
    }
    ...
    public void Debug_TypedArray_ReflectSet_ValueOf_Case_Breakdown_For_Float64Array()
    {
        ...
        Assert.That(
            ...
            Is.EqualTo("empty:0|short-ta:0|nonext:0|accessor:0|readonly:0")
        );
    }
