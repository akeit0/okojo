...
public class NodeCommonJsTests
{
        ...
        using var runtime = NodeRuntime
            ...
            .UseModuleSourceLoader(
                new InMemoryModuleLoader(
                    new(StringComparer.Ordinal) { ["/app/main.js"] = "exports.answer = 42;" }
                )
            )
            .Build();
    ...
    public void RunMainModule_ModuleExportsPrimitiveWins()
    {
        using var runtime = NodeRuntime
            ...
            .UseModuleSourceLoader(
                new InMemoryModuleLoader(
                    new(StringComparer.Ordinal) { ["/app/main.js"] = "module.exports = 7;" }
                )
            )
            .Build();
    ...
    public void RunMainModule_LargeVarChain_NewSet_RemainsConstructable_When_Register_Goes_Wide()
    {
        ...
        source.AppendLine(
            ", s = new Set(), out = typeof Set + \"|\" + (s instanceof Set) + \"|\" + s.size;"
        );
        ...
        using var runtime = NodeRuntime
            ...
            .UseModuleSourceLoader(
                new InMemoryModuleLoader(
                    new(StringComparer.Ordinal) { ["/app/main.js"] = source.ToString() }
                )
            )
            .Build();
    ...
    public void RunMainModule_CommonJsWrapper_Exposes_NodeScopedBindings_And_RequireCacheEntry()
    {
        ...
        Assert.That(
            result.AsString(),
            Is.EqualTo(
                "true|/app/main.js|/app|/app/main.js|/app|false|true|true|/app/main.js|/app|false"
            )
        );
    }
    ...
    public void RunMainModule_FileBackedModule_Uses_ForwardedArgv_And_CurrentDirectory_For_RelativeFsReads()
    {
        ...
        try
        {
            ...
            File.WriteAllText(
                Path.Combine(appRoot, "project.explain.json"),
                """
                {
                  "name": "Okojo",
                  "tagline": "engine"
                ...
                new InMemoryModuleLoader(
                    new(StringComparer.Ordinal)
                    {
                        ...
                        ["/app/node_modules/pkg/lib/sub.js"] =
                            "module.exports = 'exports-subpath';",
                    }
                )
            )
            .Build();
    ...
    public void RunMainModule_Uses_Esm_For_Mjs_Entry()
    {
        using var runtime = NodeRuntime
            ...
            .UseModuleSourceLoader(
                new InMemoryModuleLoader(
                    new(StringComparer.Ordinal) { ["/app/main.mjs"] = "export default 42;" }
                )
            )
            .Build();
            ...
            .UseModuleSourceLoader(
                new InMemoryModuleLoader(
                    new(StringComparer.Ordinal)
                    {
                        ...
                        ["/app/node_modules/pkg/src/default.js"] =
                            """export default "default-target";""",
                    }
                )
            )
            .Build();
    ...
    public void RunMainModule_Esm_MultiNamed_Function_Import_Is_Callable()
    {
        ...
        Assert.That(
            value.AsString(),
            Is.EqualTo("function|xb|function otherValue() {\n  return 1;\n}")
        );
    }
    ...
    public void RunMainModule_Resolves_Transitive_Package_From_Symlinked_NodeModules_Package()
    {
        ...
        try
        {
            ...
            var directPackageTarget = Path.Combine(
                storeRoot,
                "direct@1.0.0",
                "node_modules",
                "direct"
            );
            var transitivePackageTarget = Path.Combine(
                storeRoot,
                "transitive@1.0.0",
                "node_modules",
                "transitive"
            ...
            File.WriteAllText(
                Path.Combine(directPackageTarget, "package.json"),
                """{ "type": "module" }"""
            );
            File.WriteAllText(
                Path.Combine(directPackageTarget, "index.js"),
                """
            ...
            File.WriteAllText(
                Path.Combine(transitivePackageTarget, "package.json"),
                """{ "type": "module" }"""
            );
            File.WriteAllText(
                Path.Combine(transitivePackageTarget, "index.js"),
                """export default "transitive";"""
            );

            TryCreateDirectoryLink(
                Path.Combine(appRoot, "node_modules", "direct"),
                directPackageTarget
            );
            TryCreateDirectoryLink(
                Path.Combine(directPackageTarget, "node_modules", "transitive"),
        ...
        static void TryCreateDirectoryLink(string linkPath, string targetPath)
        {
            ...
            {
                Assert.Ignore(
                    $"Symbolic link creation is unavailable on this machine: {ex.Message}"
                );
            }
        }
    }
    ...
    public void RunMainModule_Esm_And_CommonJs_Share_Singleton_For_Symlinked_Package()
    {
        ...
        try
        {
            ...
            File.WriteAllText(
                Path.Combine(reactTarget, "package.json"),
                """{ "main": "./index.js" }"""
            );
            File.WriteAllText(
                Path.Combine(reactTarget, "index.js"),
                """
                module.exports = {
                  useState() {
                    return "ok";
            ...
            File.WriteAllText(
                Path.Combine(depTarget, "package.json"),
                """{ "main": "./index.js" }"""
            );
            File.WriteAllText(
                Path.Combine(depTarget, "index.js"),
    ...
    public void Require_NodePath_BuiltIn_Exposes_Path_Functions()
    {
        ...
        var expected = string.Join(
            "|",
            Path.Combine("a", "b", "c"),
            Path.GetDirectoryName("a/b/c.txt") ?? ".",
            Path.GetFileName("a/b/c.txt"),
            Path.GetExtension("a/b/c.txt"),
            ...
            .UseModuleSourceLoader(
                new InMemoryModuleLoader(
                    new(StringComparer.Ordinal)
                    {
                        ...
                        ["/app/node_modules/pkg/fallback.js"] =
    ...
    public void NodeGlobals_Install_SetImmediate_And_ClearImmediate()
    {
        ...
        Assert.That(
            runtime.MainRealm.Eval("trace.join(',')").AsString(),
            Is.EqualTo("tick,promise,immediate")
        );
    }
    ...
    private static string FindRepositoryRoot()
    {
        ...
        throw new DirectoryNotFoundException(
            "Could not locate repository root for Okojo.Node integration tests."
        );
    }
