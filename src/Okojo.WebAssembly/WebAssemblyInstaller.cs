...
internal static class WebAssemblyInstaller
{
    ...
    private static JsPlainObject CreateWebAssemblyObject(
        JsRealm realm,
    ...
    )
    {
        ...
        var validate = new JsHostFunction(
            realm,
            (scoped in info) =>
            {
                var wasm = ReadWasmBytes(
                    info.Realm,
        ...
        var compile = new JsHostFunction(
            realm,
            (scoped in info) =>
            {
                try
        ...
        var instantiate = new JsHostFunction(
            realm,
            (scoped in info) =>
            {
                try
                {
                    ...
                    if (TryGetModuleHandle(args[0], out var moduleHandle))
                    {
                        var instance = moduleHandle.Backend.Instantiate(
                            ...
                            new JsObjectWasmImportResolver(
                                info.Realm,
                                moduleHandle.Backend,
                                bindings,
                                imports
                            )
                        );
                    ...
                    var compiled = bindings.Backend.Compile(wasm);
                    var moduleObject = CreateModuleObject(
                        info.Realm,
                        bindings,
                        bindings.Backend,
                        compiled
                    ...
                    var createdInstanceObject = CreateInstanceObject(
                        info.Realm,
                        bindings,
                        compiledInstance
                    );
        ...
        obj.DefineDataProperty(
            "instantiate",
            JsValue.FromObject(instantiate),
            JsShapePropertyFlags.Open
        );
        obj.DefineDataProperty(
            "Module",
            JsValue.FromObject(bindings.ModuleConstructor),
            JsShapePropertyFlags.Open
        );
        obj.DefineDataProperty(
            "Instance",
            JsValue.FromObject(bindings.InstanceConstructor),
            JsShapePropertyFlags.Open
        );
        obj.DefineDataProperty(
            "Memory",
            JsValue.FromObject(bindings.MemoryConstructor),
            JsShapePropertyFlags.Open
        );
        obj.DefineDataProperty(
            "Table",
            JsValue.FromObject(bindings.TableConstructor),
            JsShapePropertyFlags.Open
        );
        obj.DefineDataProperty(
            "Global",
            JsValue.FromObject(bindings.GlobalConstructor),
            JsShapePropertyFlags.Open
        );
        obj.DefineDataProperty(
            "RuntimeError",
            JsValue.FromObject(bindings.RuntimeErrorConstructor),
            JsShapePropertyFlags.Open
        );
        obj.DefineDataProperty(
            "CompileError",
            JsValue.FromObject(bindings.CompileErrorConstructor),
            JsShapePropertyFlags.Open
        );
        obj.DefineDataProperty(
            "LinkError",
            JsValue.FromObject(bindings.LinkErrorConstructor),
            JsShapePropertyFlags.Open
        );
        return obj;
    }
    ...
    private static WebAssemblyBindings CreateBindings(JsRealm realm, IWasmBackend backend)
    {
        ...
        var moduleConstructor = new JsHostFunction(
            realm,
            (scoped in info) =>
            {
                var wasm = ReadWasmBytes(
                ...
                return JsValue.FromObject(
                    CreateModuleObject(info.Realm, null, backend, compiled, modulePrototype)
                );
            },
            "Module",
            1,
        ...
        var instanceConstructor = new JsHostFunction(
            realm,
            (scoped in info) =>
            {
                ...
                return JsValue.FromObject(
                    CreateInstanceObject(info.Realm, null, instance, instancePrototype)
                );
            },
            "Instance",
            1,
        ...
        var memoryConstructor = new JsHostFunction(
            realm,
            (scoped in info) =>
            {
                var type = ReadMemoryType(
                    info.Realm,
                    info.Arguments.Length > 0 ? info.Arguments[0] : JsValue.Undefined
                );
                var memory = backend.CreateMemory(type);
                return JsValue.FromObject(
                    CreateMemoryObject(info.Realm, null, memory, memoryPrototype)
                );
            },
            "Memory",
            1,
        ...
        var tableConstructor = new JsHostFunction(
            realm,
            (scoped in info) =>
            {
                ...
                var initialValue =
                    info.Arguments.Length > 1 ? ConvertJsToExternRef(info.Arguments[1]) : null;
                var table = backend.CreateTable(type, initialValue);
                return JsValue.FromObject(
                    CreateTableObject(info.Realm, null, table, tablePrototype)
                );
            },
            "Table",
            1,
        ...
        var globalConstructor = new JsHostFunction(
            realm,
            (scoped in info) =>
            {
                ...
                return JsValue.FromObject(
                    CreateGlobalObject(info.Realm, null, global, globalPrototype)
                );
            },
            "Global",
            1,
        ...
        InitializePrototypeConstructorPair(
            realm,
            instanceConstructor,
            instancePrototype,
            "Instance"
    ...
    private static void InstallMemoryPrototypeMembers(JsRealm realm, WebAssemblyBindings bindings)
    {
        ...
        bindings.MemoryPrototype.DefineAccessorProperty(
            "buffer",
            bufferGetter,
            null,
            JsShapePropertyFlags.HasGetter | JsShapePropertyFlags.Configurable
        );
        bindings.MemoryPrototype.DefineDataProperty(
            "grow",
            JsValue.FromObject(grow),
            BuiltinDataPropertyFlags
        );
    }
    ...
    private static void InstallTablePrototypeMembers(JsRealm realm, WebAssemblyBindings bindings)
    {
        ...
        var get = new JsHostFunction(
            realm,
            (scoped in info) =>
            {
                var table = RequireTable(info.ThisValue);
                var index =
                    info.Arguments.Length == 0 ? 0u : info.Realm.ToUint32(info.Arguments[0]);
        ...
        bindings.TablePrototype.DefineAccessorProperty(
            "length",
            lengthGetter,
            null,
            JsShapePropertyFlags.HasGetter | JsShapePropertyFlags.Configurable
        );
        bindings.TablePrototype.DefineDataProperty(
            "get",
            JsValue.FromObject(get),
            BuiltinDataPropertyFlags
        );
        bindings.TablePrototype.DefineDataProperty(
            "set",
            JsValue.FromObject(set),
            BuiltinDataPropertyFlags
        );
        bindings.TablePrototype.DefineDataProperty(
            "grow",
    ...
    {
        var valueGetter = new JsHostFunction(
            realm,
            (scoped in info) =>
            {
        ...
        var valueSetter = new JsHostFunction(
            realm,
            (scoped in info) =>
            {
                var global = RequireGlobal(info.ThisValue);
        ...
        bindings.GlobalPrototype.DefineAccessorProperty(
            "value",
            valueGetter,
            valueSetter,
    ...
    )
    {
        ...
        obj.DefineDataProperty(
            "__jsWasmCompiledModule",
            JsValue.FromObject(new JsBoxObject(realm, compiled)),
            InternalPropertyFlags
        );
        return obj;
    }
    ...
    )
    {
        ...
        foreach (var pair in instance.Exports)
            exports.DefineDataProperty(
                pair.Key,
                ConvertExtern(realm, bindings, pair.Value),
                JsShapePropertyFlags.Open
            );
    ...
    private static JsValue ConvertExtern(
        JsRealm realm,
        WebAssemblyBindings? bindings,
        IWasmExtern wasmExtern
    )
    {
        return wasmExtern switch
        {
            ...
            _ => throw new NotSupportedException(
                $"Unsupported wasm extern type: {wasmExtern.GetType().FullName}"
            ),
        };
    }
    ...
    private static JsHostFunction CreateExportedFunction(JsRealm realm, IWasmFunction function)
    {
        return new(
            ...
            (scoped in info) =>
            {
                ...
                var wasmArgs =
                    function.Type.ParameterCount == 0
                        ? Array.Empty<WasmValue>()
                        : rentedArgs = ArrayPool<WasmValue>.Shared.Rent(
                            function.Type.ParameterCount
                        );
                var wasmResults =
                    function.Type.ResultCount == 0
                        ? Array.Empty<WasmValue>()
                        : rentedResults = ArrayPool<WasmValue>.Shared.Rent(
                            function.Type.ResultCount
                        );

                try
                {
                    for (var i = 0; i < function.Type.ParameterCount; i++)
                        wasmArgs[i] = ConvertJsToWasmValue(
                            info.Realm,
            ...
            "wasm",
            function.Type.Parameters.Count
        );
    }
    ...
    private static WasmValue ConvertJsToWasmValue(
        JsRealm realm,
        WasmValueKind kind,
        in JsValue value
    )
    {
        return kind switch
        {
            WasmValueKind.Int32 => WasmValue.FromInt32(
                unchecked((int)realm.ToIntegerOrInfinity(value))
            ),
            WasmValueKind.Int64 => WasmValue.FromInt64(
                unchecked((long)realm.ToIntegerOrInfinity(value))
            ),
            ...
            WasmValueKind.V128 => throw new JsRuntimeException(
                JsErrorKind.TypeError,
    ...
    private static byte[] ReadWasmBytes(JsRealm realm, in JsValue value)
    {
        ...
        return obj switch
        {
            ...
            JsTypedArrayObject view => CopyBufferBytes(
                view.Buffer,
                view.ByteOffset,
                view.ByteLength
            ),
            JsDataViewObject dataView => CopyBufferBytes(
                dataView.Buffer,
                dataView.ByteOffset,
                dataView.ByteLength
            ),
    ...
    private static byte[] CopyBufferBytes(
    ...
    private static WasmMemoryType ReadMemoryType(JsRealm realm, in JsValue descriptorValue)
    {
        ...
        var initial = ReadRequiredLongProperty(
            realm,
            descriptor,
            "initial",
    ...
    private static WasmTableType ReadTableType(JsRealm realm, in JsValue descriptorValue)
    {
        if (!descriptorValue.TryGetObject(out var descriptor))
            throw new JsRuntimeException(
                JsErrorKind.TypeError,
                "WebAssembly.Table descriptor must be an object"
            );
    ...
    private static WasmGlobalType ReadGlobalType(JsRealm realm, in JsValue descriptorValue)
    {
        if (!descriptorValue.TryGetObject(out var descriptor))
            throw new JsRuntimeException(
                JsErrorKind.TypeError,
                "WebAssembly.Global descriptor must be an object"
            );
    ...
    private static long ReadRequiredLongProperty(
        JsRealm realm,
        JsObject obj,
        string name,
        string error
    ...
    private static bool TryGetModuleHandle(in JsValue value, out WasmModuleHandle handle)
    {
        ...
        if (!value.TryGetObject(out var obj))
            return false;
        if (
            !TryGetBoxedValue<IWasmBackend>(obj, "__jsWasmBackend", out var backend)
            || !TryGetBoxedValue<IWasmCompiledModule>(
                obj,
                "__jsWasmCompiledModule",
                out var compiled
            )
    ...
    private static IWasmGlobal RequireGlobal(in JsValue value)
    {
        if (!TryGetGlobal(value, out var global))
            throw new JsRuntimeException(
                JsErrorKind.TypeError,
                "Receiver is not a WebAssembly.Global"
            );
        return global;
    }

    private static bool TryGetBoxedExtern<T>(
        in JsValue value,
        string propertyName,
        out T wasmExtern
    )
        ...
        where T : class
    {
        value = null!;
        if (
            !obj.TryGetProperty(propertyName, out var boxedValue)
    ...
    private static JsValue CreateRejectedPromise(
        JsRealm realm,
        WebAssemblyBindings bindings,
        Exception ex
    )
    ...
    )
    {
        ...
        if (ex is WasmCompileException compileException)
            return CreateErrorValue(
                realm,
                bindings.CompileErrorConstructor,
    ...
    ) : IWasmImportResolver
    {
        ...
        public bool TryResolveImport(WasmImportDescriptor descriptor, out IWasmExtern wasmExtern)
        {
            ...
            if (
                !importsObj.TryGetProperty(descriptor.ModuleName, out var moduleValue)
            ...
            {
                WasmExternalKind.Function => ResolveFunctionImport(
                    (WasmFunctionType)descriptor.Type,
                    value
                ),
                WasmExternalKind.Memory => ResolveMemoryImport(
                    (WasmMemoryType)descriptor.Type,
                    value
                ),
                WasmExternalKind.Table => ResolveTableImport((WasmTableType)descriptor.Type, value),
                WasmExternalKind.Global => ResolveGlobalImport(
                    (WasmGlobalType)descriptor.Type,
                    value
                ),
                _ => throw new NotSupportedException(
                    $"Unsupported wasm import kind: {descriptor.Kind}"
                ),
            };
        ...
        private IWasmExtern ResolveTableImport(WasmTableType type, in JsValue value)
        {
            ...
            throw new JsRuntimeException(
                JsErrorKind.TypeError,
                "WebAssembly table import must be a WebAssembly.Table"
            );
        }
