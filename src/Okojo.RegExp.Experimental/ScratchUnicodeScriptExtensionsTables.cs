...
internal static class ScratchUnicodeScriptExtensionsTables
{
    private static ReadOnlySpan<int> AdlamRanges =>
    [
        0x61F, 0x61F,
        0x640, 0x640,
        0x204F, 0x204F,
    ...
    private static ReadOnlySpan<int> AhomRanges =>
    [
        0x11700, 0x1171A,
        0x1171D, 0x1172B,
        0x11730, 0x11746
    ...
    private static ReadOnlySpan<int> AnatolianHieroglyphsRanges =>
    [
        0x14400, 0x14646
    ];

    private static ReadOnlySpan<int> ArabicRanges =>
    [
        0x600, 0x604,
        0x606, 0x6DC,
        0x6DE, 0x6FF,
    ...
    private static ReadOnlySpan<int> ArmenianRanges =>
    [
        0x308, 0x308,
        0x531, 0x556,
        0x559, 0x58A,
    ...
    private static ReadOnlySpan<int> AvestanRanges =>
    [
        0xB7, 0xB7,
        0x2E30, 0x2E31,
        0x10B00, 0x10B35,
    ...
    private static ReadOnlySpan<int> BalineseRanges =>
    [
        0x1B00, 0x1B4C,
        0x1B4E, 0x1B7F
    ];

    private static ReadOnlySpan<int> BamumRanges =>
    [
        0xA6A0, 0xA6F7,
        0x16800, 0x16A38
    ];

    private static ReadOnlySpan<int> BassaVahRanges =>
    [
        0x16AD0, 0x16AED,
        0x16AF0, 0x16AF5
    ];

    private static ReadOnlySpan<int> BatakRanges =>
    [
        0x1BC0, 0x1BF3,
        0x1BFC, 0x1BFF
    ];

    private static ReadOnlySpan<int> BengaliRanges =>
    [
        0x2BC, 0x2BC,
        0x951, 0x952,
        0x964, 0x965,
    ...
    private static ReadOnlySpan<int> BeriaErfeRanges =>
    [
        0x16EA0, 0x16EB8,
        0x16EBB, 0x16ED3
    ];

    private static ReadOnlySpan<int> BhaiksukiRanges =>
    [
        0x11C00, 0x11C08,
        0x11C0A, 0x11C36,
        0x11C38, 0x11C45,
    ...
    private static ReadOnlySpan<int> BopomofoRanges =>
    [
        0x2C7, 0x2C7,
        0x2C9, 0x2CB,
        0x2D9, 0x2D9,
    ...
    private static ReadOnlySpan<int> BrahmiRanges =>
    [
        0x11000, 0x1104D,
        0x11052, 0x11075,
        0x1107F, 0x1107F
    ...
    private static ReadOnlySpan<int> BrailleRanges =>
    [
        0x2800, 0x28FF
    ];

    private static ReadOnlySpan<int> BugineseRanges =>
    [
        0x1A00, 0x1A1B,
        0x1A1E, 0x1A1F,
        0xA9CF, 0xA9CF
    ...
    private static ReadOnlySpan<int> BuhidRanges =>
    [
        0x1735, 0x1736,
        0x1740, 0x1753
    ];

    private static ReadOnlySpan<int> CanadianAboriginalRanges =>
    [
        0x1400, 0x167F,
        0x18B0, 0x18F5,
        0x11AB0, 0x11ABF
    ...
    private static ReadOnlySpan<int> CarianRanges =>
    [
        0xB7, 0xB7,
        0x205A, 0x205A,
        0x205D, 0x205D,
    ...
    private static ReadOnlySpan<int> CaucasianAlbanianRanges =>
    [
        0x304, 0x304,
        0x331, 0x331,
        0x35E, 0x35E,
    ...
    private static ReadOnlySpan<int> ChakmaRanges =>
    [
        0x9E6, 0x9EF,
        0x1040, 0x1049,
        0x11100, 0x11134,
    ...
    private static ReadOnlySpan<int> ChamRanges =>
    [
        0xAA00, 0xAA36,
        0xAA40, 0xAA4D,
        0xAA50, 0xAA59,
    ...
    private static ReadOnlySpan<int> CherokeeRanges =>
    [
        0x300, 0x302,
        0x304, 0x304,
        0x30B, 0x30C,
    ...
    private static ReadOnlySpan<int> ChorasmianRanges =>
    [
        0x10FB0, 0x10FCB
    ];

    private static ReadOnlySpan<int> CommonRanges =>
    [
        0x0, 0x40,
        0x5B, 0x60,
        0x7B, 0xA9,
    ...
    private static ReadOnlySpan<int> CopticRanges =>
    [
        0xB7, 0xB7,
        0x300, 0x300,
        0x304, 0x305,
    ...
    private static ReadOnlySpan<int> CuneiformRanges =>
    [
        0x12000, 0x12399,
        0x12400, 0x1246E,
        0x12470, 0x12474,
    ...
    private static ReadOnlySpan<int> CypriotRanges =>
    [
        0x10100, 0x10102,
        0x10107, 0x10133,
        0x10137, 0x1013F,
    ...
    private static ReadOnlySpan<int> CyproMinoanRanges =>
    [
        0x10100, 0x10101,
        0x12F90, 0x12FF2
    ];

    private static ReadOnlySpan<int> CyrillicRanges =>
    [
        0x2BC, 0x2BC,
        0x300, 0x302,
        0x304, 0x304,
    ...
    private static ReadOnlySpan<int> DeseretRanges =>
    [
        0x10400, 0x1044F
    ];

    private static ReadOnlySpan<int> DevanagariRanges =>
    [
        0x2BC, 0x2BC,
        0x900, 0x952,
        0x955, 0x97F,
    ...
    private static ReadOnlySpan<int> DivesAkuruRanges =>
    [
        0x11900, 0x11906,
        0x11909, 0x11909,
        0x1190C, 0x11913,
    ...
    private static ReadOnlySpan<int> DograRanges =>
    [
        0x964, 0x96F,
        0xA830, 0xA839,
        0x11800, 0x1183B
    ...
    private static ReadOnlySpan<int> DuployanRanges =>
    [
        0xB7, 0xB7,
        0x307, 0x308,
        0x30A, 0x30A,
    ...
    private static ReadOnlySpan<int> EgyptianHieroglyphsRanges =>
    [
        0x13000, 0x13455,
        0x13460, 0x143FA
    ];

    private static ReadOnlySpan<int> ElbasanRanges =>
    [
        0xB7, 0xB7,
        0x305, 0x305,
        0x10500, 0x10527
    ...
    private static ReadOnlySpan<int> ElymaicRanges =>
    [
        0x10FE0, 0x10FF6
    ];

    private static ReadOnlySpan<int> EthiopicRanges =>
    [
        0x30E, 0x30E,
        0x1200, 0x1248,
        0x124A, 0x124D,
    ...
    private static ReadOnlySpan<int> GarayRanges =>
    [
        0x60C, 0x60C,
        0x61B, 0x61B,
        0x61F, 0x61F,
    ...
    private static ReadOnlySpan<int> GeorgianRanges =>
    [
        0xB7, 0xB7,
        0x589, 0x589,
        0x10A0, 0x10C5,
    ...
    private static ReadOnlySpan<int> GlagoliticRanges =>
    [
        0xB7, 0xB7,
        0x303, 0x303,
        0x305, 0x305,
    ...
    private static ReadOnlySpan<int> GothicRanges =>
    [
        0xB7, 0xB7,
        0x304, 0x305,
        0x308, 0x308,
    ...
    private static ReadOnlySpan<int> GranthaRanges =>
    [
        0x951, 0x952,
        0x964, 0x965,
        0xBE6, 0xBF3,
    ...
    private static ReadOnlySpan<int> GreekRanges =>
    [
        0xB7, 0xB7,
        0x300, 0x301,
        0x304, 0x304,
    ...
    private static ReadOnlySpan<int> GujaratiRanges =>
    [
        0x951, 0x952,
        0x964, 0x965,
        0xA81, 0xA83,
    ...
    private static ReadOnlySpan<int> GunjalaGondiRanges =>
    [
        0xB7, 0xB7,
        0x964, 0x965,
        0x11D60, 0x11D65,
    ...
    private static ReadOnlySpan<int> GurmukhiRanges =>
    [
        0x951, 0x952,
        0x964, 0x965,
        0xA01, 0xA03,
    ...
    private static ReadOnlySpan<int> GurungKhemaRanges =>
    [
        0x965, 0x965,
        0x16100, 0x16139
    ];

    private static ReadOnlySpan<int> HanRanges =>
    [
        0xB7, 0xB7,
        0x2E80, 0x2E99,
        0x2E9B, 0x2EF3,
    ...
    private static ReadOnlySpan<int> HangulRanges =>
    [
        0x1100, 0x11FF,
        0x3001, 0x3003,
        0x3008, 0x3011,
    ...
    private static ReadOnlySpan<int> HanifiRohingyaRanges =>
    [
        0x60C, 0x60C,
        0x61B, 0x61B,
        0x61F, 0x61F,
    ...
    private static ReadOnlySpan<int> HanunooRanges =>
    [
        0x1720, 0x1736
    ];

    private static ReadOnlySpan<int> HatranRanges =>
    [
        0x108E0, 0x108F2,
        0x108F4, 0x108F5,
        0x108FB, 0x108FF
    ...
    private static ReadOnlySpan<int> HebrewRanges =>
    [
        0x307, 0x308,
        0x591, 0x5C7,
        0x5D0, 0x5EA,
    ...
    private static ReadOnlySpan<int> HiraganaRanges =>
    [
        0x3001, 0x3003,
        0x3008, 0x3011,
        0x3013, 0x301F,
    ...
    private static ReadOnlySpan<int> ImperialAramaicRanges =>
    [
        0x10840, 0x10855,
        0x10857, 0x1085F
    ];

    private static ReadOnlySpan<int> InheritedRanges =>
    [
        0x30F, 0x30F,
        0x312, 0x312,
        0x314, 0x322,
    ...
    private static ReadOnlySpan<int> InscriptionalPahlaviRanges =>
    [
        0x10B60, 0x10B72,
        0x10B78, 0x10B7F
    ];

    private static ReadOnlySpan<int> InscriptionalParthianRanges =>
    [
        0x10B40, 0x10B55,
        0x10B58, 0x10B5F
    ];

    private static ReadOnlySpan<int> JavaneseRanges =>
    [
        0xA980, 0xA9CD,
        0xA9CF, 0xA9D9,
        0xA9DE, 0xA9DF
    ...
    private static ReadOnlySpan<int> KaithiRanges =>
    [
        0x966, 0x96F,
        0x2E31, 0x2E31,
        0xA830, 0xA839,
    ...
    private static ReadOnlySpan<int> KannadaRanges =>
    [
        0x951, 0x952,
        0x964, 0x965,
        0xC80, 0xC8C,
    ...
    private static ReadOnlySpan<int> KatakanaRanges =>
    [
        0x305, 0x305,
        0x323, 0x323,
        0x3001, 0x3003,
    ...
    private static ReadOnlySpan<int> KawiRanges =>
    [
        0x11F00, 0x11F10,
        0x11F12, 0x11F3A,
        0x11F3E, 0x11F5A
    ...
    private static ReadOnlySpan<int> KayahLiRanges =>
    [
        0xA900, 0xA92F
    ];

    private static ReadOnlySpan<int> KharoshthiRanges =>
    [
        0x10A00, 0x10A03,
        0x10A05, 0x10A06,
        0x10A0C, 0x10A13,
    ...
    private static ReadOnlySpan<int> KhitanSmallScriptRanges =>
    [
        0x16FE4, 0x16FE4,
        0x18B00, 0x18CD5,
        0x18CFF, 0x18CFF
    ...
    private static ReadOnlySpan<int> KhmerRanges =>
    [
        0x1780, 0x17DD,
        0x17E0, 0x17E9,
        0x17F0, 0x17F9,
    ...
    private static ReadOnlySpan<int> KhojkiRanges =>
    [
        0xAE6, 0xAEF,
        0xA830, 0xA839,
        0x11200, 0x11211,
    ...
    private static ReadOnlySpan<int> KhudawadiRanges =>
    [
        0x964, 0x965,
        0xA830, 0xA839,
        0x112B0, 0x112EA,
    ...
    private static ReadOnlySpan<int> KiratRaiRanges =>
    [
        0x16D40, 0x16D79
    ];

    private static ReadOnlySpan<int> LaoRanges =>
    [
        0xE81, 0xE82,
        0xE84, 0xE84,
        0xE86, 0xE8A,
    ...
    private static ReadOnlySpan<int> LatinRanges =>
    [
        0x41, 0x5A,
        0x61, 0x7A,
        0xAA, 0xAA,
    ...
    private static ReadOnlySpan<int> LepchaRanges =>
    [
        0x1C00, 0x1C37,
        0x1C3B, 0x1C49,
        0x1C4D, 0x1C4F
    ...
    private static ReadOnlySpan<int> LimbuRanges =>
    [
        0x965, 0x965,
        0x1900, 0x191E,
        0x1920, 0x192B,
    ...
    private static ReadOnlySpan<int> LinearARanges =>
    [
        0x10107, 0x10133,
        0x10600, 0x10736,
        0x10740, 0x10755,
    ...
    private static ReadOnlySpan<int> LinearBRanges =>
    [
        0x10000, 0x1000B,
        0x1000D, 0x10026,
        0x10028, 0x1003A,
    ...
    private static ReadOnlySpan<int> LisuRanges =>
    [
        0x2BC, 0x2BC,
        0x2CD, 0x2CD,
        0x300A, 0x300B,
    ...
    private static ReadOnlySpan<int> LycianRanges =>
    [
        0x205A, 0x205A,
        0x10280, 0x1029C
    ];

    private static ReadOnlySpan<int> LydianRanges =>
    [
        0xB7, 0xB7,
        0x2E31, 0x2E31,
        0x10920, 0x10939,
    ...
    private static ReadOnlySpan<int> MahajaniRanges =>
    [
        0xB7, 0xB7,
        0x964, 0x96F,
        0xA830, 0xA839,
    ...
    private static ReadOnlySpan<int> MakasarRanges =>
    [
        0x11EE0, 0x11EF8
    ];

    private static ReadOnlySpan<int> MalayalamRanges =>
    [
        0x951, 0x952,
        0x964, 0x965,
        0xD00, 0xD0C,
    ...
    private static ReadOnlySpan<int> MandaicRanges =>
    [
        0x640, 0x640,
        0x840, 0x85B,
        0x85E, 0x85E
    ...
    private static ReadOnlySpan<int> ManichaeanRanges =>
    [
        0x640, 0x640,
        0x10AC0, 0x10AE6,
        0x10AEB, 0x10AF6
    ...
    private static ReadOnlySpan<int> MarchenRanges =>
    [
        0x11C70, 0x11C8F,
        0x11C92, 0x11CA7,
        0x11CA9, 0x11CB6
    ...
    private static ReadOnlySpan<int> MasaramGondiRanges =>
    [
        0x964, 0x965,
        0x11D00, 0x11D06,
        0x11D08, 0x11D09,
    ...
    private static ReadOnlySpan<int> MedefaidrinRanges =>
    [
        0x16E40, 0x16E9A
    ];

    private static ReadOnlySpan<int> MeeteiMayekRanges =>
    [
        0xAAE0, 0xAAF6,
        0xABC0, 0xABED,
        0xABF0, 0xABF9
    ...
    private static ReadOnlySpan<int> MendeKikakuiRanges =>
    [
        0x1E800, 0x1E8C4,
        0x1E8C7, 0x1E8D6
    ];

    private static ReadOnlySpan<int> MeroiticCursiveRanges =>
    [
        0x109A0, 0x109B7,
        0x109BC, 0x109CF,
        0x109D2, 0x109FF
    ...
    private static ReadOnlySpan<int> MeroiticHieroglyphsRanges =>
    [
        0x205D, 0x205D,
        0x10980, 0x1099F
    ];

    private static ReadOnlySpan<int> MiaoRanges =>
    [
        0x16F00, 0x16F4A,
        0x16F4F, 0x16F87,
        0x16F8F, 0x16F9F
    ...
    private static ReadOnlySpan<int> ModiRanges =>
    [
        0xA830, 0xA839,
        0x11600, 0x11644,
        0x11650, 0x11659
    ...
    private static ReadOnlySpan<int> MongolianRanges =>
    [
        0x1800, 0x1819,
        0x1820, 0x1878,
        0x1880, 0x18AA,
    ...
    private static ReadOnlySpan<int> MroRanges =>
    [
        0x16A40, 0x16A5E,
        0x16A60, 0x16A69,
        0x16A6E, 0x16A6F
    ...
    private static ReadOnlySpan<int> MultaniRanges =>
    [
        0xA66, 0xA6F,
        0x11280, 0x11286,
        0x11288, 0x11288,
    ...
    private static ReadOnlySpan<int> MyanmarRanges =>
    [
        0x1000, 0x109F,
        0xA92E, 0xA92E,
        0xA9E0, 0xA9FE,
    ...
    private static ReadOnlySpan<int> NabataeanRanges =>
    [
        0x10880, 0x1089E,
        0x108A7, 0x108AF
    ];

    private static ReadOnlySpan<int> NagMundariRanges =>
    [
        0x1E4D0, 0x1E4F9
    ];

    private static ReadOnlySpan<int> NandinagariRanges =>
    [
        0x951, 0x951,
        0x964, 0x965,
        0xCE6, 0xCEF,
    ...
    private static ReadOnlySpan<int> NewTaiLueRanges =>
    [
        0x1980, 0x19AB,
        0x19B0, 0x19C9,
        0x19D0, 0x19DA,
    ...
    private static ReadOnlySpan<int> NewaRanges =>
    [
        0x951, 0x952,
        0x1CD5, 0x1CD5,
        0x1CD7, 0x1CD8,
    ...
    private static ReadOnlySpan<int> NkoRanges =>
    [
        0x60C, 0x60C,
        0x61B, 0x61B,
        0x61F, 0x61F,
    ...
    private static ReadOnlySpan<int> NushuRanges =>
    [
        0x16FE1, 0x16FE1,
        0x1B170, 0x1B2FB
    ];

    private static ReadOnlySpan<int> NyiakengPuachueHmongRanges =>
    [
        0x1E100, 0x1E12C,
        0x1E130, 0x1E13D,
        0x1E140, 0x1E149,
    ...
    private static ReadOnlySpan<int> OghamRanges =>
    [
        0x1680, 0x169C
    ];

    private static ReadOnlySpan<int> OlChikiRanges =>
    [
        0x1C50, 0x1C7F
    ];

    private static ReadOnlySpan<int> OlOnalRanges =>
    [
        0x964, 0x965,
        0x1E5D0, 0x1E5FA,
        0x1E5FF, 0x1E5FF
    ...
    private static ReadOnlySpan<int> OldHungarianRanges =>
    [
        0x205A, 0x205A,
        0x205D, 0x205D,
        0x2E31, 0x2E31,
    ...
    private static ReadOnlySpan<int> OldItalicRanges =>
    [
        0x10300, 0x10323,
        0x1032D, 0x1032F
    ];

    private static ReadOnlySpan<int> OldNorthArabianRanges =>
    [
        0x10A80, 0x10A9F
    ];

    private static ReadOnlySpan<int> OldPermicRanges =>
    [
        0xB7, 0xB7,
        0x300, 0x300,
        0x306, 0x308,
    ...
    private static ReadOnlySpan<int> OldPersianRanges =>
    [
        0x103A0, 0x103C3,
        0x103C8, 0x103D5
    ];

    private static ReadOnlySpan<int> OldSogdianRanges =>
    [
        0x10F00, 0x10F27
    ];

    private static ReadOnlySpan<int> OldSouthArabianRanges =>
    [
        0x10A60, 0x10A7F
    ];

    private static ReadOnlySpan<int> OldTurkicRanges =>
    [
        0x205A, 0x205A,
        0x2E30, 0x2E30,
        0x10C00, 0x10C48
    ...
    private static ReadOnlySpan<int> OldUyghurRanges =>
    [
        0x640, 0x640,
        0x10AF2, 0x10AF2,
        0x10F70, 0x10F89
    ...
    private static ReadOnlySpan<int> OriyaRanges =>
    [
        0x951, 0x952,
        0x964, 0x965,
        0xB01, 0xB03,
    ...
    private static ReadOnlySpan<int> OsageRanges =>
    [
        0x301, 0x301,
        0x304, 0x304,
        0x30B, 0x30B,
    ...
    private static ReadOnlySpan<int> OsmanyaRanges =>
    [
        0x10480, 0x1049D,
        0x104A0, 0x104A9
    ];

    private static ReadOnlySpan<int> PahawhHmongRanges =>
    [
        0x16B00, 0x16B45,
        0x16B50, 0x16B59,
        0x16B5B, 0x16B61,
    ...
    private static ReadOnlySpan<int> PalmyreneRanges =>
    [
        0x10860, 0x1087F
    ];

    private static ReadOnlySpan<int> PauCinHauRanges =>
    [
        0x11AC0, 0x11AF8
    ];

    private static ReadOnlySpan<int> PhagsPaRanges =>
    [
        0x1802, 0x1803,
        0x1805, 0x1805,
        0x202F, 0x202F,
    ...
    private static ReadOnlySpan<int> PhoenicianRanges =>
    [
        0x10900, 0x1091B,
        0x1091F, 0x1091F
    ];

    private static ReadOnlySpan<int> PsalterPahlaviRanges =>
    [
        0x640, 0x640,
        0x10B80, 0x10B91,
        0x10B99, 0x10B9C,
    ...
    private static ReadOnlySpan<int> RejangRanges =>
    [
        0xA930, 0xA953,
        0xA95F, 0xA95F
    ];

    private static ReadOnlySpan<int> RunicRanges =>
    [
        0x16A0, 0x16F8
    ];

    private static ReadOnlySpan<int> SamaritanRanges =>
    [
        0x800, 0x82D,
        0x830, 0x83E,
        0x2E31, 0x2E31
    ...
    private static ReadOnlySpan<int> SaurashtraRanges =>
    [
        0xA880, 0xA8C5,
        0xA8CE, 0xA8D9
    ];

    private static ReadOnlySpan<int> SharadaRanges =>
    [
        0x951, 0x951,
        0x1CD7, 0x1CD7,
        0x1CD9, 0x1CD9,
    ...
    private static ReadOnlySpan<int> ShavianRanges =>
    [
        0xB7, 0xB7,
        0x10450, 0x1047F
    ];

    private static ReadOnlySpan<int> SiddhamRanges =>
    [
        0x11580, 0x115B5,
        0x115B8, 0x115DD
    ];

    private static ReadOnlySpan<int> SideticRanges =>
    [
        0x10940, 0x10959
    ];

    private static ReadOnlySpan<int> SignWritingRanges =>
    [
        0x1D800, 0x1DA8B,
        0x1DA9B, 0x1DA9F,
        0x1DAA1, 0x1DAAF
    ...
    private static ReadOnlySpan<int> SinhalaRanges =>
    [
        0x964, 0x965,
        0xD81, 0xD83,
        0xD85, 0xD96,
    ...
    private static ReadOnlySpan<int> SogdianRanges =>
    [
        0x640, 0x640,
        0x10F30, 0x10F59
    ];

    private static ReadOnlySpan<int> SoraSompengRanges =>
    [
        0x110D0, 0x110E8,
        0x110F0, 0x110F9
    ];

    private static ReadOnlySpan<int> SoyomboRanges =>
    [
        0x11A50, 0x11AA2
    ];

    private static ReadOnlySpan<int> SundaneseRanges =>
    [
        0x1B80, 0x1BBF,
        0x1CC0, 0x1CC7
    ];

    private static ReadOnlySpan<int> SunuwarRanges =>
    [
        0x300, 0x301,
        0x303, 0x303,
        0x30D, 0x30D,
    ...
    private static ReadOnlySpan<int> SylotiNagriRanges =>
    [
        0x964, 0x965,
        0x9E6, 0x9EF,
        0xA800, 0xA82C
    ...
    private static ReadOnlySpan<int> SyriacRanges =>
    [
        0x303, 0x304,
        0x307, 0x308,
        0x30A, 0x30A,
    ...
    private static ReadOnlySpan<int> TagalogRanges =>
    [
        0x1700, 0x1715,
        0x171F, 0x171F,
        0x1735, 0x1736
    ...
    private static ReadOnlySpan<int> TagbanwaRanges =>
    [
        0x1735, 0x1736,
        0x1760, 0x176C,
        0x176E, 0x1770,
    ...
    private static ReadOnlySpan<int> TaiLeRanges =>
    [
        0x300, 0x301,
        0x307, 0x308,
        0x30C, 0x30C,
    ...
    private static ReadOnlySpan<int> TaiThamRanges =>
    [
        0x1A20, 0x1A5E,
        0x1A60, 0x1A7C,
        0x1A7F, 0x1A89,
    ...
    private static ReadOnlySpan<int> TaiVietRanges =>
    [
        0xAA80, 0xAAC2,
        0xAADB, 0xAADF
    ];

    private static ReadOnlySpan<int> TaiYoRanges =>
    [
        0x1E6C0, 0x1E6DE,
        0x1E6E0, 0x1E6F5,
        0x1E6FE, 0x1E6FF
    ...
    private static ReadOnlySpan<int> TakriRanges =>
    [
        0x964, 0x965,
        0xA830, 0xA839,
        0x11680, 0x116B9,
    ...
    private static ReadOnlySpan<int> TamilRanges =>
    [
        0x951, 0x952,
        0x964, 0x965,
        0xB82, 0xB83,
    ...
    private static ReadOnlySpan<int> TangsaRanges =>
    [
        0x16A70, 0x16ABE,
        0x16AC0, 0x16AC9
    ];

    private static ReadOnlySpan<int> TangutRanges =>
    [
        0x2FF0, 0x2FFF,
        0x31EF, 0x31EF,
        0x16FE0, 0x16FE0,
    ...
    private static ReadOnlySpan<int> TeluguRanges =>
    [
        0x951, 0x952,
        0x964, 0x965,
        0xC00, 0xC0C,
    ...
    private static ReadOnlySpan<int> ThaanaRanges =>
    [
        0x60C, 0x60C,
        0x61B, 0x61C,
        0x61F, 0x61F,
    ...
    private static ReadOnlySpan<int> ThaiRanges =>
    [
        0x2BC, 0x2BC,
        0x2D7, 0x2D7,
        0x303, 0x303,
    ...
    private static ReadOnlySpan<int> TibetanRanges =>
    [
        0xF00, 0xF47,
        0xF49, 0xF6C,
        0xF71, 0xF97,
    ...
    private static ReadOnlySpan<int> TifinaghRanges =>
    [
        0x302, 0x302,
        0x304, 0x304,
        0x306, 0x309,
    ...
    private static ReadOnlySpan<int> TirhutaRanges =>
    [
        0x951, 0x952,
        0x964, 0x965,
        0x1CD5, 0x1CD5,
    ...
    private static ReadOnlySpan<int> TodhriRanges =>
    [
        0x301, 0x301,
        0x304, 0x304,
        0x307, 0x307,
    ...
    private static ReadOnlySpan<int> TolongSikiRanges =>
    [
        0x11DB0, 0x11DDB,
        0x11DE0, 0x11DE9
    ];

    private static ReadOnlySpan<int> TotoRanges =>
    [
        0x2BC, 0x2BC,
        0x1E290, 0x1E2AE
    ];

    private static ReadOnlySpan<int> TuluTigalariRanges =>
    [
        0xCE6, 0xCEF,
        0x1CF2, 0x1CF2,
        0x1CF4, 0x1CF4,
    ...
    private static ReadOnlySpan<int> UgariticRanges =>
    [
        0x10380, 0x1039D,
        0x1039F, 0x1039F
    ];

    private static ReadOnlySpan<int> UnknownRanges =>
    [
        0x378, 0x379,
        0x380, 0x383,
        0x38B, 0x38B,
    ...
    private static ReadOnlySpan<int> VaiRanges =>
    [
        0xA500, 0xA62B
    ];

    private static ReadOnlySpan<int> VithkuqiRanges =>
    [
        0x10570, 0x1057A,
        0x1057C, 0x1058A,
        0x1058C, 0x10592,
    ...
    private static ReadOnlySpan<int> WanchoRanges =>
    [
        0x1E2C0, 0x1E2F9,
        0x1E2FF, 0x1E2FF
    ];

    private static ReadOnlySpan<int> WarangCitiRanges =>
    [
        0x118A0, 0x118F2,
        0x118FF, 0x118FF
    ];

    private static ReadOnlySpan<int> YezidiRanges =>
    [
        0x60C, 0x60C,
        0x61B, 0x61B,
        0x61F, 0x61F,
    ...
    private static ReadOnlySpan<int> YiRanges =>
    [
        0x3001, 0x3002,
        0x3008, 0x3011,
        0x3014, 0x301B,
    ...
    private static ReadOnlySpan<int> ZanabazarSquareRanges =>
    [
        0x11A00, 0x11A47
    ];

    public static bool IsSupported(string scriptExtensions)
    {
    ...
    public static bool Contains(string scriptExtensions, int codePoint)
    {
        return scriptExtensions switch
        {
    ...
    private static bool ContainsRange(ReadOnlySpan<int> ranges, int codePoint)
    {
        return ScratchUnicodeRangeSearch.ContainsRange(ranges, codePoint);
    }
}
