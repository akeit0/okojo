...
public readonly struct PropertyDescriptor
{
    ...
    public static PropertyDescriptor Const(
        JsValue value,
        bool writable = false,
    ...
    public static PropertyDescriptor Data(
        JsValue value,
        bool writable = false,
        bool enumerable = false,
        bool configurable = false
    ...
    public static PropertyDescriptor GetterData(
        JsFunction getter,
        bool enumerable = false,
        bool configurable = false
    )
    ...
    public static PropertyDescriptor SetterData(
        JsFunction value,
        bool enumerable = false,
        bool configurable = false
    )
    ...
    public static PropertyDescriptor GetterSetterData(
        JsFunction getter,
        JsFunction setter,
        bool enumerable = false,
        bool configurable = false
