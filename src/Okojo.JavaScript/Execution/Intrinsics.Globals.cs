...
public partial class Intrinsics
{
    ...
    private static void PrepareIndirectEvalDeclarationInstantiation(
        JsRealm realm,
        JsProgram program
    )
    {
        ...
        foreach (var statement in statements)
            switch (statement)
            {
                ...
                case JsForStatement forStatement:
                    if (
                        forStatement.Init is JsVariableDeclarationStatement initDeclaration
                ...
                case JsForInOfStatement forInOfStatement:
                    if (
                        forInOfStatement.Left is JsVariableDeclarationStatement leftDeclaration
    ...
    private static string DecodeUriString(JsRealm realm, string input, bool preserveReserved)
    {
        ...
        for (var i = 0; i < input.Length; i++)
        {
            ...
            if (
                Rune.DecodeFromUtf8(bytes[..byteCount], out var rune, out var consumed)
