...
public partial class Intrinsics
{
    private void InstallDataViewBuiltins()
    {
        ...
        Span<(
            string Name,
            int Size,
            Func<JsArrayBufferObject, uint, bool, JsValue> Getter
        )> getDefs =
        [
            ...
            (
                "getInt16",
                2,
                static (buffer, index, le) => JsValue.FromInt32(buffer.GetInt16(index, le))
            ),
            (
                "getUint16",
                2,
                static (buffer, index, le) => JsValue.FromInt32(buffer.GetUInt16(index, le))
            ),
            (
                "getInt32",
                4,
                static (buffer, index, le) => JsValue.FromInt32(buffer.GetInt32(index, le))
            ),
            (
                "getUint32",
                4,
                static (buffer, index, le) => new((double)buffer.GetUInt32(index, le))
            ),
            (
                "getFloat16",
                2,
                static (buffer, index, le) => new((double)buffer.GetFloat16(index, le))
            ),
        ...
        Span<(
            ...
            Action<JsArrayBufferObject, uint, bool, JsValue> Setter
        )> setDefs =
        [
            (
                "setInt8",
                ...
                static (buffer, index, _, value) =>
                    buffer.SetInt8(index, unchecked((sbyte)value.Int32Value))
            ),
            (
                "setUint8",
                1,
                ...
                static (buffer, index, _, value) =>
                    buffer.SetByte(index, unchecked((byte)value.Int32Value))
            ),
            (
                "setInt16",
                2,
                ...
                static (buffer, index, le, value) =>
                    buffer.SetInt16(index, unchecked((short)value.Int32Value), le)
            ),
            (
                "setUint16",
                2,
                ...
                static (buffer, index, le, value) =>
                    buffer.SetUInt16(index, unchecked((ushort)value.Int32Value), le)
            ),
            (
                "setInt32",
                4,
            ...
            (
                ...
                static (buffer, index, le, value) =>
                    buffer.SetUInt32(index, unchecked((uint)value.NumberValue), le)
            ),
            (
                "setFloat16",
                2,
                ...
                static (buffer, index, le, value) =>
                    buffer.SetFloat16(index, (Half)value.NumberValue, le)
            ),
            (
                "setFloat32",
                4,
                ...
                static (buffer, index, le, value) =>
                    buffer.SetFloat32(index, (float)value.NumberValue, le)
            ),
            (
                "setFloat64",
                8,
                        ...
                        new JsHostFunction(
                            ...
                            (in info) =>
                            {
                                ...
                                var offset =
                                    args.Length == 0
                                        ? 0u
                                        : realm.ToTypedArrayLengthOrOffset(
                                            args[0],
