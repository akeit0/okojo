...
public partial class Intrinsics
{
    ...
    private static readonly Action<object?> SExecuteThenableResolveJob = static state =>
    {
        ...
        try
        {
            var inlineArray = new InlineJsValueArray2 { Item0 = job.Resolve, Item1 = job.Reject };
            var args = inlineArray.AsSpan();
            if (job.ThenFunction is JsHostFunction host)
                job.Realm.InvokeHostFunctionWithExitFrame(
                    host,
                    job.Resolution,
                    args,
                    0,
            ...
            if (job.ThenFunction is JsBytecodeFunction bytecodeFunc)
                job.Realm.InvokeBytecodeFunction(
                    bytecodeFunc,
                    job.Resolution,
                    args,
                    JsValue.Undefined
        ...
        catch (JsRuntimeException ex)
        {
            if (job.TargetHolder.Value != null)
                job.Realm.RejectPromise(
                    (JsPromiseObject)job.Target,
                    job.Realm.GetPromiseAbruptReason(ex)
                );
        }
    };
    ...
    {
        var promise = new JsPromiseObject(Realm) { Prototype = PromisePrototype };
        return promise;
    }
    ...
    {
        var promise = new JsPromiseObject(Realm) { Prototype = prototype };
        return promise;
    }
    ...
    )
    {
        ...
        resolve = new(
            ...
            (in info) =>
            {
                ...
                innerVm.Intrinsics.ResolvePromiseWithAssimilation(
                    state.Promise,
        ...
        reject = new(
            ...
            (in info) =>
            {
                ...
                if (state.AlreadyResolved)
                    return JsValue.Undefined;
                state.AlreadyResolved = true;
                innerVm.Intrinsics.RejectPromise(
                    state.Promise,
                    innerArgs.Length > 0 ? innerArgs[0] : JsValue.Undefined
                );
                return JsValue.Undefined;
    ...
    private JsHostFunction CreatePromiseConstructor()
    {
        return new(
            ...
            (in info) =>
            {
                ...
                if (
                    args.Length == 0
                    || !args[0].TryGetObject(out var execObj)
                    || execObj is not JsFunction executor
                )
                    throw new JsRuntimeException(
                        JsErrorKind.TypeError,
                ...
                var promise = CreatePromiseObject(
                    GetPrototypeFromConstructorOrIntrinsic(
                        info.NewTarget,
                        callee,
                        callee.Realm.PromisePrototype
                    )
                );
                ...
                var resolveArgs = new InlineJsValueArray2 { Item0 = resolve, Item1 = reject };
                try
                {
                ...
                catch (JsRuntimeException ex)
                {
                    if (!settleState.AlreadyResolved)
                        realm.Intrinsics.RejectPromise(
                            promise,
    ...
    private void InstallPromiseConstructorBuiltins()
    {
        ...
        var catchFn = new JsHostFunction(
            Realm,
            (in info) =>
            {
                var realm = info.Realm;
        ...
        var finallyFn = new JsHostFunction(
            Realm,
            (in info) =>
            {
                var realm = info.Realm;
        ...
        var resolveFn = new JsHostFunction(
            Realm,
            (in info) =>
            {
                var realm = info.Realm;
        ...
        var rejectFn = new JsHostFunction(
            Realm,
            (in info) =>
            {
                var realm = info.Realm;
                if (
                    ...
                    throw new JsRuntimeException(
                        JsErrorKind.TypeError,
                        "Promise.reject requires a constructor receiver"
                    );
                var args = info.Arguments;
                var value = args.Length > 0 ? args[0] : JsValue.Undefined;
        ...
        var raceFn = new JsHostFunction(
            ...
            (in info) =>
            {
                ...
                if (
                    ...
                    throw new JsRuntimeException(
                        JsErrorKind.TypeError,
                        "Promise.race requires a constructor receiver"
                    );
        ...
        var allFn = new JsHostFunction(
            ...
            (in info) =>
            {
                ...
                if (
                    ...
                    throw new JsRuntimeException(
                        JsErrorKind.TypeError,
                        "Promise.all requires a constructor receiver"
                    );
                var args = info.Arguments;
                var iterable = args.Length > 0 ? args[0] : JsValue.Undefined;
        ...
        var anyFn = new JsHostFunction(
            ...
            (in info) =>
            {
                ...
                if (
                    ...
                    throw new JsRuntimeException(
                        JsErrorKind.TypeError,
                        "Promise.any requires a constructor receiver"
                    );
                var args = info.Arguments;
                var iterable = args.Length > 0 ? args[0] : JsValue.Undefined;
        ...
        var allSettledFn = new JsHostFunction(
            Realm,
            (in info) =>
            {
                var realm = info.Realm;
        ...
        var withResolversFn = new JsHostFunction(
            Realm,
            (in info) =>
            {
                var realm = info.Realm;
                ...
                var resolveWrapper = new JsHostFunction(
                    realm,
                    static (in forwardInfo) =>
                    {
                        var realm = forwardInfo.Realm;
                        var target = (JsFunction)((JsHostFunction)forwardInfo.Function).UserData!;
                        var value =
                            forwardInfo.Arguments.Length > 0
                                ? forwardInfo.Arguments[0]
                                : JsValue.Undefined;
                ...
                var rejectWrapper = new JsHostFunction(
                    realm,
                    static (in forwardInfo) =>
                    {
                        var realm = forwardInfo.Realm;
                ...
                return realm.Intrinsics.CreatePromiseWithResolversResult(
                    capability.Promise,
                    resolveWrapper,
                    rejectWrapper
                );
    ...
    )
    {
        ...
        return CreateAsyncFromSyncIteratorResultPromise(
            value,
            done,
            iteratorToClose,
            closeOnRejection
    ...
    )
    {
        ...
        if (
            !valuePromiseValue.TryGetObject(out var valuePromiseObj)
    ...
    internal JsPromiseObject.PromiseCapability CreatePromiseCapability(JsFunction ctor)
    {
        ...
        var executor = new JsHostFunction(
            Realm,
            static (in info) =>
            {
                ...
                var resolve =
                    args.Length > 0 && args[0].TryGetObject(out var resolveObj)
                        ? resolveObj as JsFunction
                        : null;
                var reject =
                    args.Length > 1 && args[1].TryGetObject(out var rejectObj)
                        ? rejectObj as JsFunction
                        : null;
        ...
        var promise = Realm.ConstructWithExplicitNewTarget(
            ctor,
        ...
        if (!promise.TryGetObject(out var promiseObj))
            throw new JsRuntimeException(
                JsErrorKind.TypeError,
                "Promise capability constructor must return an object"
            );
    ...
    {
        if (
            !ctor.TryGetPropertyByAtom(IdResolve, out var resolveValue)
    ...
    internal JsValue PromiseResolveByConstructor(JsFunction ctor, in JsValue value)
    {
        if (value.TryGetObject(out var valueObj) && valueObj is JsPromiseObject)
            if (
                valueObj.TryGetPropertyAtom(Realm, IdConstructor, out var constructorValue, out _)
    ...
    {
        if (
            !promise.TryGetPropertyAtom(Realm, IdConstructor, out var ctorValue, out _)
        ...
        if (ctorObj.TryGetPropertyAtom(Realm, IdSymbolSpecies, out var speciesValue, out _))
        {
            ...
            throw new JsRuntimeException(
                JsErrorKind.TypeError,
                "Promise [Symbol.species] must be a constructor"
            );
        }
    ...
    private JsValue InvokePromiseThen(
    ...
    )
    {
        ...
        if (
            !promiseObj.TryGetPropertyAtom(Realm, IdThen, out var thenValue, out _)
            || !thenValue.TryGetObject(out var thenObj)
            || thenObj is not JsFunction thenFn
        )
            throw new JsRuntimeException(
                JsErrorKind.TypeError,
                "Promise receiver does not provide a callable then"
            );

        var inlineArgs = new InlineJsValueArray2 { Item0 = onFulfilled, Item1 = onRejected };
    ...
    private JsValue PromiseFinally(in JsValue thisValue, in JsValue onFinally)
    {
        ...
        if (
            !onFinally.TryGetObject(out var onFinallyObj)
            || onFinallyObj is not JsFunction onFinallyFn
        )
            return InvokePromiseThen(thisValue, onFinally, onFinally);

        var finallyState = new PromiseFinallyState(constructor, onFinallyFn);
        var thenFinally = new JsHostFunction(
            Realm,
            (in info) =>
            {
                var realm = info.Realm;
                ...
                var promise = realm.Intrinsics.PromiseResolveByConstructor(
                    state.Constructor,
                    result
                );
                if (
                    !promise.TryGetObject(out var promiseObj)
                    || !promiseObj.TryGetPropertyAtom(realm, IdThen, out var thenValue, out _)
                    || !thenValue.TryGetObject(out var thenObj)
                    || thenObj is not JsFunction thenFn
                )
                ...
                var valueThunk = new JsHostFunction(
                    realm,
                    static (in thunkInfo) =>
                    {
        ...
        var catchFinally = new JsHostFunction(
            Realm,
            (in info) =>
            {
                var realm = info.Realm;
                ...
                var thrower = new JsHostFunction(
                    realm,
                    static (in thunkInfo) =>
                    {
                        var thunkHost = (JsHostFunction)thunkInfo.Function;
                        ...
                        throw new JsRuntimeException(
                            JsErrorKind.InternalError,
                            "Promise finally rejection passthrough",
    ...
    internal void ResolvePromiseWithAssimilation(JsPromiseObject target, in JsValue resolution)
    {
        ...
        var resolveFn = new JsHostFunction(
            ...
            static (in info) =>
            {
                ...
                holder.Value = null;
                f.UserData = null;
                realm.Intrinsics.ResolvePromiseWithAssimilation(
                    target,
        ...
        Realm.Agent.EnqueuePromiseJob(
            SExecuteThenableResolveJob,
            new PromiseThenableResolveJobState(
                Realm,
                resolutionValue,
                target,
                thenFn,
    ...
    internal void RejectPromise(JsPromiseObject promise, in JsValue reason)
    {
        ...
        if (!promise.IsHandled)
            Realm.Agent.EnqueuePromiseJob(SUnhandledRejectionCheckJob, promise);
    }
    ...
    )
    {
        ...
        switch (reaction.Kind)
        {
            ...
            case JsPromiseObject.Reaction.ReactionKind.ResumeAsyncDriver:
            {
                ...
                var mode =
                    settledState == JsPromiseObject.PromiseState.Fulfilled
                        ? GeneratorResumeMode.Next
                        : GeneratorResumeMode.Throw;
            ...
            case JsPromiseObject.Reaction.ReactionKind.CompleteAsyncFromSyncIteratorResult:
            {
                ...
                if (settledState == JsPromiseObject.PromiseState.Fulfilled)
                {
                    Realm.ResolvePromise(
                        resolution.Promise,
                        JsValue.FromObject(
                            Realm.CreateIteratorResultObject(settledResult, resolution.Done)
                        )
                    );
                }
                else
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private bool CanUseIntrinsicPromiseCombinatorFastPath(
        JsFunction ctor,
    ...
    )
    {
        if (
            ...
            || !ReferenceEquals(promiseResolve, promiseResolveFunction)
        )
            return false;
        return PromisePrototype.TryGetOwnNamedPropertyDescriptorAtom(
                Realm,
                IdThen,
                out var descriptor
            )
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private void EnqueueImmediatePromiseHandlerJob(
        in JsValue onFulfilled,
        in JsValue onRejected,
        in JsValue value
    )
    {
        ...
        var valueCopy = value;
        Realm.Agent.EnqueuePromiseJob(
            SExecuteImmediatePromiseHandlerJob,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private void CompletePromiseCapability(
        JsPromiseObject.PromiseCapability capability,
        in JsValue value,
        bool isReject
    )
    {
        ...
        _ = Realm.InvokeFunction(
            reject,
            JsValue.Undefined,
            MemoryMarshal.CreateReadOnlySpan(ref arg0Reject, 1)
        );
    }
