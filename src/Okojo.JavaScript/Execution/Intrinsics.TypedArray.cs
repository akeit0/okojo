...
public partial class Intrinsics
{
    internal JsHostFunction CreateTypedArrayConstructor(TypedArrayElementKind kind)
    {
        ...
        return new(
            ...
            (in info) =>
            {
                ...
                if (args.Length != 0 && args[0].TryGetObject(out arg0Obj))
                ...
                var prototype = GetTypedArrayConstructionPrototype(
                    realm,
                    kind,
                    info.NewTarget,
                    callee
            ...
            static (in info) =>
            {
                ...
                var byteOffset =
                    args.Length > 1 && !args[1].IsUndefined
                        ? realm.ToTypedArrayByteOffset(args[1])
                        : 0;
                ...
                var prototype = realm.Intrinsics.GetPrototypeFromConstructorOrIntrinsic(
                    info.NewTarget,
                    callee,
    ...
    private void InstallTypedArrayConstructorBuiltins()
    {
        ...
        var lengthGetter = new JsHostFunction(
            Realm,
            static (in info) =>
            {
                var realm = info.Realm;
        ...
        var byteLengthGetter = new JsHostFunction(
            Realm,
            static (in info) =>
            {
                var realm = info.Realm;
        ...
        var bufferGetter = new JsHostFunction(
            Realm,
            static (in info) =>
            {
                var realm = info.Realm;
        ...
        var byteOffsetGetter = new JsHostFunction(
            Realm,
            static (in info) =>
            {
                var realm = info.Realm;
        ...
        var toStringTagGetter = new JsHostFunction(
            Realm,
            static (in info) =>
            {
                var thisValue = info.ThisValue;
        ...
        var fromFn = new JsHostFunction(
            ...
            static (in info) =>
            {
                ...
                {
                    if (
                        !args[1].TryGetObject(out var mapFnObj)
                        || mapFnObj is not JsFunction callback
                    )
                        throw new JsRuntimeException(
                            JsErrorKind.TypeError,
                            "TypedArray.from mapfn must be a function"
                        );
                    mapFn = callback;
                    if (args.Length > 2)
                        thisArg = args[2];
                ...
                if (JsRealm.TryGetIteratorObjectForArrayFrom(realm, items, out var iterator))
                {
                    ...
                    {
                        Item0 =
                            sourceValues.Count <= int.MaxValue
                                ? JsValue.FromInt32(sourceValues.Count)
                                : new(sourceValues.Count),
                    };
                    var iterTargetValue = realm.ConstructWithExplicitNewTarget(
                        ctor,
                        iterLenArg.AsSpan(),
                        ctor,
                        0
                    );
                    var iterTarget = RequireTypedArrayCreateResult(
                        realm,
                        iterTargetValue,
                        (uint)sourceValues.Count
                    );

                    for (var i = 0; i < sourceValues.Count; i++)
                    {
                        var mappedValue = MapTypedArrayFromValue(
                            realm,
                            mapFn,
                            thisArg,
                            sourceValues[i],
                ...
                if (TryGetTypedArrayFromLength(realm, items, out var sourceLength))
                {
                    ...
                    var targetValue = realm.ConstructWithExplicitNewTarget(
                        ctor,
                        lenArg.AsSpan(),
                        ctor,
                        0
        ...
        var ofFn = new JsHostFunction(
            ...
            static (in info) =>
            {
                ...
                {
                    Item0 =
                        args.Length <= int.MaxValue
                            ? JsValue.FromInt32(args.Length)
                            : new(args.Length),
                };
                var targetValue = realm.ConstructWithExplicitNewTarget(
                    ctor,
        ...
        var fromBase64Fn = new JsHostFunction(
            Realm,
            static (in info) =>
            {
                var realm = info.Realm;
                ...
                if (args.Length > 1 && !args[1].IsUndefined)
                {
                    ...
                    if (
                        options.TryGetProperty("alphabet", out var alphabetValue)
                        && !alphabetValue.IsUndefined
                    )
                    {
                    ...
                    if (
                        options.TryGetProperty("lastChunkHandling", out var handlingValue)
                        && !handlingValue.IsUndefined
                    )
                    {
        ...
        var fromHexFn = new JsHostFunction(
            Realm,
            static (in info) =>
            {
                var realm = info.Realm;
                ...
                if (args.Length == 0 || !args[0].IsString)
                    throw new JsRuntimeException(
                        JsErrorKind.TypeError,
                        "Uint8Array.fromHex source must be a string"
                    );
        ...
        var setFromBase64Fn = new JsHostFunction(
            Realm,
            static (in info) =>
            {
                var realm = info.Realm;
                ...
                var (read, written) = SetUint8ArrayFromBase64(
                    realm,
                    target,
                    source,
                    alphabet,
        ...
        var setFromHexFn = new JsHostFunction(
            Realm,
            static (in info) =>
            {
                var realm = info.Realm;
        ...
        var toBase64Fn = new JsHostFunction(
            Realm,
            static (in info) =>
            {
                var realm = info.Realm;
                ...
                if (args.Length > 0 && !args[0].IsUndefined)
                {
                    ...
                    if (
                        options.TryGetProperty("omitPadding", out var omitPaddingValue)
                        && !omitPaddingValue.IsUndefined
                    )
        ...
        var toHexFn = new JsHostFunction(
            Realm,
            static (in info) =>
            {
                var realm = info.Realm;
        ...
        var atFn = new JsHostFunction(
            ...
            static (in info) =>
            {
                ...
                if (actualIndex < 0d || actualIndex >= length)
                    return JsValue.Undefined;
                return typedArray.TryGetElement((uint)actualIndex, out var value)
                    ? value
                    : JsValue.Undefined;
            },
            "at",
        ...
        var copyWithinFn = new JsHostFunction(
            ...
            static (in info) =>
            {
                ...
                var final =
                    args.Length > 2
                        ? realm.NormalizeRelativeIndex(relativeEnd, snapLen, snapLen)
                        : snapshotLength;
        ...
        var valuesFn = new JsHostFunction(
            ...
            static (in info) =>
            {
                ...
                return new JsArrayIteratorObject(
                    realm,
                    ValidateTypedArray(realm, thisValue),
        ...
        var subarrayFn = new JsHostFunction(
            Realm,
            static (in info) =>
            {
                var realm = info.Realm;
                ...
                var sourceLength =
                    typedArray.Buffer.IsDetached && !typedArray.IsLengthTracking
                        ? typedArray.StoredLength
                        : typedArray.Length;
                var sourceByteOffset = typedArray.StoredByteOffset;
                var beginIndex = realm.NormalizeRelativeIndex(
                ...
                var byteOffset = checked(
                    sourceByteOffset + beginIndex * (uint)typedArray.BytesPerElement
                );
                ...
                if (typedArray.IsLengthTracking && endIsUndefined)
                {
                    ...
                    var lengthTrackingCreated = realm.ConstructWithExplicitNewTarget(
                        ctor,
                        lengthTrackingCtorArgs.AsSpan(),
                        ctor,
                        0
                    );
                ...
                var ctorArgs = new InlineJsValueArray3
                {
                    ...
                    Item2 =
                        newLength <= int.MaxValue
                            ? JsValue.FromInt32((int)newLength)
                            : new((double)newLength),
                };
                var createdValue = realm.ConstructWithExplicitNewTarget(
                    ctor,
                    ctorArgs.AsSpan(),
                    ctor,
                    0
        ...
        var setFn = new JsHostFunction(
            ...
            static (in info) =>
            {
                ...
                var targetOffset =
                    args.Length > 1
                        ? realm.ToTypedArrayLengthOrOffset(args[1], "offset is out of bounds")
                        : 0;
                if (target.IsOutOfBounds)
                    throw new JsRuntimeException(
                        JsErrorKind.TypeError,
                ...
                {
                    var values = CollectTypedArraySetSourceValues(
                        realm,
                        target.Kind,
                        sourceTypedArray
                    );
                ...
                for (uint index = 0; index < sourceLength; index++)
                {
                    var value = source.TryGetElement(index, out var elementValue)
                        ? elementValue
                        : JsValue.Undefined;
        ...
        var everyFn = new JsHostFunction(
            ...
            static (in info) =>
            {
                ...
                for (uint index = 0; index < length; index++)
                {
                    ...
                    if (
                        !realm
                            .InvokeFunction(callbackFn, thisArg, callbackArgs.AsSpan())
                            .ToBoolean()
                    )
        ...
        var someFn = new JsHostFunction(
            ...
            static (in info) =>
            {
                ...
                for (uint index = 0; index < length; index++)
                {
                    ...
                    if (
                        realm.InvokeFunction(callbackFn, thisArg, callbackArgs.AsSpan()).ToBoolean()
                    )
                        return JsValue.True;
                }
        ...
        var fillFn = new JsHostFunction(
            ...
            static (in info) =>
            {
                ...
                var normalizedValue = TypedArrayElementKindInfo.NormalizeValue(
                    realm,
                    typedArray.Kind,
                    fillValue
                );
                var startIndex =
                    args.Length > 1 ? realm.NormalizeRelativeIndex(args[1], initialLength, 0) : 0;
                var endIndex =
                    args.Length > 2 && !args[2].IsUndefined
        ...
        var mapFn = new JsHostFunction(
            ...
            static (in info) =>
            {
                ...
                for (uint index = 0; index < length; index++)
                {
                    ...
                    var mappedValue = realm.InvokeFunction(
                        callbackFn,
                        thisArg,
                        callbackArgs.AsSpan()
                    );
        ...
        var sliceFn = new JsHostFunction(
            ...
            static (in info) =>
            {
                ...
                var length = typedArray.Length;
                var beginIndex =
                    args.Length > 0 ? realm.NormalizeRelativeIndex(args[0], length, 0) : 0;
                var endIndex =
                    args.Length > 1
        ...
        var includesFn = new JsHostFunction(
            ...
            static (in info) =>
            {
                ...
                var startIndex =
                    args.Length > 1 ? realm.NormalizeRelativeIndex(args[1], length, 0) : 0;
        ...
        var lastIndexOfFn = new JsHostFunction(
            ...
            static (in info) =>
            {
                ...
                var startIndex =
                    args.Length > 1 ? realm.NormalizeLastIndex(args[1], length) : length - 1L;
        ...
        var withFn = new JsHostFunction(
            ...
            static (in info) =>
            {
                ...
                var length = typedArray.Length;
                var relativeIndex = args.Length == 0 ? 0d : realm.ToIntegerOrInfinity(args[0]);
                var actualIndexDouble =
                    relativeIndex >= 0d ? relativeIndex : length + relativeIndex;

                var replacement = args.Length > 1 ? args[1] : JsValue.Undefined;
                var normalizedReplacement = TypedArrayElementKindInfo.NormalizeValue(
                    realm,
                    typedArray.Kind,
                    replacement
                );
        ...
        var iteratorNextFn = new JsHostFunction(
            ...
            static (in info) =>
            {
                ...
                if (
                    ...
                    || obj is not TypedArrayIteratorObject iterator
                )
                    throw new JsRuntimeException(
                        JsErrorKind.TypeError,
        ...
        for (var i = 0; i < 12; i++)
        {
            ...
            ctor.DefineDataPropertyAtom(
                Realm,
                atomBytesPerElement,
                JsValue.FromInt32(bpe),
    ...
    private static uint ToTypedArrayLength(JsRealm realm, in JsValue value)
    {
        ...
        if (number < 0d || double.IsInfinity(number) || number > uint.MaxValue)
            throw new JsRuntimeException(
                JsErrorKind.RangeError,
                $"Invalid typed array length: {number}"
            );
        return (uint)number;
    }
    ...
    private static JsTypedArrayObject CreateTypedArrayView(
        JsRealm realm,
    ...
    )
    {
        ...
        var byteOffset =
            args.Length > 1 && !args[1].IsUndefined ? realm.ToTypedArrayByteOffset(args[1]) : 0u;
        if (buffer.IsDetached)
            throw new JsRuntimeException(JsErrorKind.TypeError, "ArrayBuffer is detached");
        ...
        if (requiredBytes > initialBufferByteLength - byteOffset)
            throw new JsRuntimeException(
                JsErrorKind.RangeError,
                $"Invalid typed array length: {length}"
            );
    ...
    private static JsObject GetTypedArrayConstructionPrototype(
        JsRealm realm,
        TypedArrayElementKind kind,
        in JsValue newTarget,
        JsHostFunction callee
    ...
    private static JsValue ReduceTypedArray(
        JsRealm realm,
    ...
    )
    {
        ...
        if (
            ...
            throw new JsRuntimeException(
                JsErrorKind.TypeError,
                $"{methodName} callbackfn must be a function"
            );
        ...
        for (; fromRight ? index >= 0 : index < length; index += fromRight ? -1 : 1)
        {
            ...
            accumulator = realm.InvokeFunction(
                callbackFn,
                JsValue.Undefined,
                callbackArgs.AsSpan()
            );
    ...
    private static List<JsValue> CollectTypedArraySetSourceValues(
        JsRealm realm,
        TypedArrayElementKind targetKind,
    ...
    private static JsTypedArrayObject CreateTypedArrayFromObject(
        JsRealm realm,
        TypedArrayElementKind kind,
        JsObject source,
        in JsValue newTarget,
    ...
    )
    {
        ...
        if (source is JsArray array)
            return CreateTypedArrayFromArrayLike(
                realm,
                kind,
                newTarget,
                callee,
                ...
                static (_, sourceLocal, index) =>
                    ((JsArray)sourceLocal).TryGetElement(index, out var value)
                        ? value
                        : JsValue.Undefined,
                source,
                mapFn,
        ...
        if (source is JsStringObject stringObject)
        {
            ...
            foreach (var rune in stringObject.Value.EnumerateRunes())
                values.Add(
                    MapTypedArrayFromValue(realm, mapFn, thisArg, rune.ToString(), values.Count)
                );
            return CreateTypedArrayFromValues(realm, kind, newTarget, callee, values);
        }
    ...
    private static List<JsValue> CollectTypedArrayFromSourceValues(
        JsRealm realm,
        JsObject source,
        JsFunction? mapFn,
        in JsValue thisArg
    )
    {
        ...
        if (source is JsArray array)
        {
            ...
            for (uint index = 0; index < array.Length; index++)
                values.Add(
                    MapTypedArrayFromValue(
                        realm,
                        mapFn,
                        thisArg,
                        array.TryGetElement(index, out var value) ? value : JsValue.Undefined,
                        index
                    )
                );
            return values;
        ...
        for (uint index = 0; index < length; index++)
            result.Add(
                MapTypedArrayFromValue(
                    ...
                    mapFn,
                    thisArg,
                    source.TryGetElement(index, out var value) ? value : JsValue.Undefined,
                    index
                )
            );
        return result;
    ...
    private static JsTypedArrayObject CreateTypedArrayFromArrayLike(
        JsRealm realm,
        TypedArrayElementKind kind,
        in JsValue newTarget,
        JsHostFunction callee,
        uint length,
        Func<JsRealm, JsObject, uint, JsValue> getter,
        JsObject source,
        JsFunction? mapFn,
        in JsValue thisArg
    )
    ...
    private static JsTypedArrayObject CreateTypedArrayFromValues(
        JsRealm realm,
        TypedArrayElementKind kind,
        in JsValue newTarget,
        JsHostFunction callee,
    ...
    private static JsTypedArrayObject CreateTypedArraySpeciesResult(
        JsRealm realm,
        JsTypedArrayObject exemplar,
        List<JsValue> values
    )
    {
    ...
    private static JsTypedArrayObject CreateTypedArraySameTypeResult(
        JsRealm realm,
        JsTypedArrayObject exemplar,
        uint length
    )
    ...
    private static JsFunction GetTypedArraySpeciesConstructor(
        JsRealm realm,
        JsTypedArrayObject exemplar
    )
    {
        ...
        if (
            ctorObj.TryGetPropertyAtom(realm, IdSymbolSpecies, out var speciesValue, out _)
            && !speciesValue.IsUndefined
            && !speciesValue.IsNull
        )
        {
            if (
                !speciesValue.TryGetObject(out var speciesObj)
                || speciesObj is not JsFunction speciesFn
    ...
    private static JsValue GetTypedArrayFromSourceValue(JsRealm realm, JsObject source, uint index)
    {
        ...
        if (source is JsArray array)
            return array.TryGetElement(index, out var value) ? value : JsValue.Undefined;
    ...
    private static JsTypedArrayObject RequireTypedArrayCreateResult(
        JsRealm realm,
        in JsValue value,
        uint? requiredLength
    )
    {
        ...
        if (requiredLength.HasValue && typedArray.Length < requiredLength.Value)
            throw new JsRuntimeException(
                JsErrorKind.TypeError,
                "Constructed TypedArray is too small"
            );
        return typedArray;
    }

    private static JsValue MapTypedArrayFromValue(
        JsRealm realm,
        JsFunction? mapFn,
        in JsValue thisArg,
        in JsValue value,
    ...
    private static byte[] DecodeUint8ArrayBase64(
        string source,
        string alphabet,
    ...
    )
    {
        ...
        while (position < source.Length)
        {
            ...
            DecodeFinalUnpaddedBase64Chunk(
                bytes,
                source.AsSpan(position),
                base64Url,
                lastChunkHandling
            );
    ...
    private static void DecodeFinalPaddedBase64Chunk(
        List<byte> bytes,
        char a,
        char b,
        char c,
    ...
    private static void DecodeFinalUnpaddedBase64Chunk(
        List<byte> bytes,
    ...
    )
    {
        ...
        for (var i = 0; i < chunk.Length; i++)
            ...
            {
                if (
                    lastChunkHandling == Base64LastChunkHandling.StopBeforePartial
                    && chunk.Length == 3
                    && chunk[2] == '='
    ...
    {
        if (
            realm.ArrayPrototype.TryGetPropertyAtom(realm, IdToString, out var toStringValue, out _)
        )
            return toStringValue;
        throw new InvalidOperationException(
            "Array.prototype.toString must be installed before TypedArray builtins."
        );
    }
