...
internal sealed class JsClrEnumeratorObject : JsObject
{
        ...
        : base(realm)
    {
        ...
        var nextFn = new JsHostFunction(
            ...
            static (in info) =>
            {
                if (
                    ...
                    || thisObj is not JsClrEnumeratorObject iterator
                )
        ...
        var returnFn = new JsHostFunction(
            ...
            static (in info) =>
            {
                ...
                return JsValue.FromObject(
                    iterator.Return(info.GetArgumentOrDefault(0, JsValue.Undefined))
                );
            },
            "return",
            1
        ...
        DefineDataPropertyAtom(
            realm,
            IdSymbolIterator,
            JsValue.FromObject(realm.Intrinsics.IteratorSelfFunction),
            JsShapePropertyFlags.Open
        );
    }
