...
public partial class Intrinsics
{
    ...
    private static bool IsValidVariant(string part) => Locale.IsValidVariant(part);

    private static string GetLanguageSubtag(string locale) => Locale.GetLanguageSubtag(locale);
