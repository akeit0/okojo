...
public partial class Intrinsics
{
    ...
    {
        GeneratorObjectPrototype = new(Realm, false) { Prototype = IteratorPrototype };
        ...
        [
            PropertyDefinition.Const(
                IdConstructor,
                JsValue.FromObject(GeneratorFunctionPrototype),
                configurable: true
            ),
            PropertyDefinition.Const(
                IdSymbolToStringTag,
        ...
        GeneratorFunctionPrototype.DefineNewPropertiesNoCollision(
            Realm,
            generatorFunctionPrototypeDefs
        );
