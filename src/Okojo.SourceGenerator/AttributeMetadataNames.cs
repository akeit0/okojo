...
internal static class AttributeMetadataNames
{
    ...
    public const string JsIgnoreFromObjectAttribute =
        "Okojo.Annotations.JsIgnoreFromObjectAttribute";
    public const string JsIgnoreFromGlobalsAttribute =
        "Okojo.Annotations.JsIgnoreFromGlobalsAttribute";
