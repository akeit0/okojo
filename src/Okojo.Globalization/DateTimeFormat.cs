...
public sealed class DateTimeFormat
{
    ...
    private string FormatWeekday(DateTimeValue dateTime)
    {
    ...
    private string FormatYear(DateTimeValue dateTime)
    {
    ...
    private string FormatMonth(DateTimeValue dateTime)
    {
        return Month switch
        {
    ...
    private string FormatDay(DateTimeValue dateTime)
    {
        return Day switch
        {
    ...
    private string GetMonthText(DateTimeValue dateTime, string width)
    {
        if (dateTime.NativeDateTime.HasValue)
            return width switch
            {
    ...
    private string FormatFullFallback(DateTimeValue dateTime)
    {
        var builder = new StringBuilder();
